...
/*  54 */       this.appender = (Appender<E>)OptionHelper.instantiateByClassName(className, Appender.class, this.context);
...
/*     */       } 
/*  71 */       HashMap<String, Appender<E>> appenderBag = (HashMap<String, Appender<E>>)ec.getObjectMap().get("APPENDER_BAG");
...
/*  91 */     if (this.inError)
/*     */       return; 
/*  95 */     if (this.appender instanceof ch.qos.logback.core.spi.LifeCycle)
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\joran\action\AppenderAction.class
