...
/*     */   }
/*     */   
/*  92 */   private long invocationCounter = 0L;
/*     */   
/*  94 */   private volatile long mask = 15L;
/*     */   
/*  95 */   private volatile long lastMaskCheck = System.currentTimeMillis();
/*     */   
...
/* 147 */       this.mask = this.mask << 1L | 0x1L;
...
/*     */     public void run() {
/* 187 */       if (ReconfigureOnChangeFilter.this.mainConfigurationURL == null) {
...
/* 236 */         } catch (JoranException e) {
/* 237 */           ReconfigureOnChangeFilter.this.addError("Unexpected exception thrown by a configuration considered safe.", (Throwable)e);
/*     */         } 
/*     */       } else {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\classic\turbo\ReconfigureOnChangeFilter.class
