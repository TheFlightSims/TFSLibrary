...
/*  48 */     if (name == null)
/*  49 */       throw new IllegalArgumentException("A merker name cannot be null"); 
/*  51 */     this.name = name;
/*     */   }
/*     */   
...
/* 104 */       Marker m = this.refereceList.get(i);
...
/* 124 */         Marker ref = this.refereceList.get(i);
...
/* 147 */         Marker ref = this.refereceList.get(i);
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\slf4j\helpers\BasicMarker.class
