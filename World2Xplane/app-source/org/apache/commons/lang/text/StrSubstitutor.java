...
/*     */     } 
/* 192 */     return replace(source, valueMap);
/*     */   }
/*     */   
...
/* 222 */     this(StrLookup.mapLookup(valueMap), DEFAULT_PREFIX, DEFAULT_SUFFIX, '$');
/*     */   }
/*     */   
/*     */   public StrSubstitutor(Map valueMap, String prefix, String suffix) {
/* 234 */     this(StrLookup.mapLookup(valueMap), prefix, suffix, '$');
/*     */   }
/*     */   
...
/* 658 */             change += varLen - endPos - startPos;
/* 660 */             pos += change;
/* 661 */             bufEnd += change;
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\lang\text\StrSubstitutor.class
