...
public final class BooleanType extends Type {
  ...
  public int compare(Session paramSession, Object paramObject1, Object paramObject2) {
    ...
    return (bool1 == bool2) ? 0 : (bool2 ? -1 : 1);
  }
  ...
  public Object convertToType(SessionInterface paramSessionInterface, Object paramObject, Type paramType) {
    ...
    switch (paramType.typeCode) {
      ...
      case 14:
      case 15:
        binaryData = (BinaryData)paramObject;
        if (binaryData.bitLength(paramSessionInterface) == 1L)
      ...
      case 1:
      case 12:
        paramObject = ((CharacterType)paramType).trim(paramSessionInterface, paramObject, ' ', true, true);
      ...
      case 5:
      case 25:
        return (((Number)paramObject).longValue() == 0L) ? Boolean.FALSE : Boolean.TRUE;
    } 
  ...
  public String convertToString(Object paramObject) {
    return (paramObject == null) ? null : (((Boolean)paramObject).booleanValue() ? "TRUE" : "FALSE");
  }
  
  public String convertToSQLString(Object paramObject) {
    return (paramObject == null) ? "UNKNOWN" : (((Boolean)paramObject).booleanValue() ? "TRUE" : "FALSE");
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\types\BooleanType.class
