...
/*  74 */     return (ServerListener<RemoteAppenderClient>)new RemoteAppenderServerListener(socket);
/*     */   }
/*     */   
/*     */   protected ServerRunner createServerRunner(ServerListener<RemoteAppenderClient> listener, Executor executor) {
/*  80 */     return (ServerRunner)new RemoteAppenderServerRunner(listener, executor);
/*     */   }
/*     */   
/*     */   protected Runnable getRunnableTask() {
/*  85 */     return (Runnable)this.runner;
/*     */   }
/*     */   
