...
public class XMLDTDProcessor implements XMLComponent, XMLDTDFilter, XMLDTDContentModelFilter {
  ...
  public void attributeDecl(String paramString1, String paramString2, String paramString3, String[] paramArrayOfString, String paramString4, XMLString paramXMLString1, XMLString paramXMLString2, Augmentations paramAugmentations) throws XNIException {
    ...
    if (this.fValidation) {
      ...
      if (paramString3 == XMLSymbols.fENUMERATIONSymbol || paramString3 == XMLSymbols.fNOTATIONSymbol) {
        byte b;
        label108: for (b = 0; b < paramArrayOfString.length; b++) {
          for (int j = b + 1; j < paramArrayOfString.length; j++) {
            if (paramArrayOfString[b].equals(paramArrayOfString[j])) {
  ...
  public void endDTD(Augmentations paramAugmentations) throws XNIException {
    ...
    if (this.fValidation) {
      DTDGrammar dTDGrammar = (this.fDTDGrammar != null) ? this.fDTDGrammar : this.fGrammarBucket.getActiveGrammar();
      Enumeration enumeration1 = this.fNDataDeclNotations.keys();
      while (enumeration1.hasMoreElements()) {
        String str1 = enumeration1.nextElement();
        String str2 = (String)this.fNDataDeclNotations.get(str1);
        if (dTDGrammar.getNotationDeclIndex(str2) == -1)
          this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_NOTATION_NOT_DECLARED_FOR_UNPARSED_ENTITYDECL", new Object[] { str1, str2 }, (short)1); 
      } 
      Enumeration enumeration2 = this.fNotationEnumVals.keys();
      while (enumeration2.hasMoreElements()) {
        String str1 = enumeration2.nextElement();
        String str2 = (String)this.fNotationEnumVals.get(str1);
        if (dTDGrammar.getNotationDeclIndex(str1) == -1)
          this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_NOTATION_NOT_DECLARED_FOR_NOTATIONTYPE_ATTRIBUTE", new Object[] { str2, str1 }, (short)1); 
      } 
      Enumeration enumeration3 = this.fTableOfNOTATIONAttributeNames.keys();
      while (enumeration3.hasMoreElements()) {
        String str = enumeration3.nextElement();
        int i = dTDGrammar.getElementDeclIndex(str);
        if (dTDGrammar.getContentSpecType(i) == 1) {
          String str1 = (String)this.fTableOfNOTATIONAttributeNames.get(str);
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\dtd\XMLDTDProcessor.class
