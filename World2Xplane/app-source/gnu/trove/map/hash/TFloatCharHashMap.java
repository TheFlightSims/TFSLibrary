...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TFloatCharHashMap) {
/*  134 */       TFloatCharHashMap hashmap = (TFloatCharHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Float, ? extends Character> entry : map.entrySet())
/*  234 */       put(((Float)entry.getKey()).floatValue(), ((Character)entry.getValue()).charValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TFloatCharMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TFloatCharIterator iter = map.iterator();
...
/*  393 */     return new TFloatCharHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TFloatCharHashMap.TFloatCharKeyHashIterator((TPrimitiveHash)TFloatCharHashMap.this);
/*      */     }
/*      */     
/*      */     public float getNoEntryValue() {
/*  521 */       return TFloatCharHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TFloatCharHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TFloatCharHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(float entry) {
/*  539 */       return TFloatCharHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public float[] toArray() {
/*  545 */       return TFloatCharHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public float[] toArray(float[] dest) {
/*  551 */       return TFloatCharHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TFloatCharHashMap.this.no_entry_value != TFloatCharHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TFloatCharHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TFloatCharHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TFloatCharHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       float[] set = TFloatCharHashMap.this._set;
/*  677 */       byte[] states = TFloatCharHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TFloatCharHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TFloatCharHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TFloatProcedure procedure) {
/*  742 */       return TFloatCharHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TFloatCharHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TFloatCharHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TFloatCharHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TFloatCharHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TFloatCharHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TFloatCharHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TFloatCharHashMap.this.forEachKey(new TFloatProcedure() {
...
/*  807 */       return new TFloatCharHashMap.TFloatCharValueHashIterator((TPrimitiveHash)TFloatCharHashMap.this);
/*      */     }
/*      */     
/*      */     public char getNoEntryValue() {
/*  813 */       return TFloatCharHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TFloatCharHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TFloatCharHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(char entry) {
/*  831 */       return TFloatCharHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public char[] toArray() {
/*  837 */       return TFloatCharHashMap.this.values();
/*      */     }
/*      */     
/*      */     public char[] toArray(char[] dest) {
/*  843 */       return TFloatCharHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       char[] values = TFloatCharHashMap.this._values;
/*  856 */       float[] set = TFloatCharHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0.0F && set[i] != 2.0F && entry == values[i]) {
/*  860 */           TFloatCharHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TFloatCharHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TFloatCharHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TFloatCharHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       char[] values = TFloatCharHashMap.this._values;
/*  962 */       byte[] states = TFloatCharHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TFloatCharHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TFloatCharHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TCharProcedure procedure) {
/* 1027 */       return TFloatCharHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TFloatCharHashMap.this.forEachValue(new TCharProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TFloatCharHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TFloatCharHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TFloatCharHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TFloatCharHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public float key() {
/* 1148 */       return TFloatCharHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public char value() {
/* 1153 */       return TFloatCharHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public char setValue(char val) {
/* 1158 */       char old = value();
/* 1159 */       TFloatCharHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TFloatCharHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TFloatCharMap))
/* 1185 */       return false; 
/* 1187 */     TFloatCharMap that = (TFloatCharMap)other;
...
/* 1230 */     forEachEntry(new TFloatCharProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TFloatCharHashMap.class
