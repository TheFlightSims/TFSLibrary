...
/*  268 */       ByteBuffer rawBytes = ByteBuffer.allocate(16);
/*      */       try {
/*      */         int j;
...
/*  649 */       this.server = (Inet4Address)Objects.firstNonNull(server, InetAddresses.ANY4);
/*  650 */       this.client = (Inet4Address)Objects.firstNonNull(client, InetAddresses.ANY4);
/*  651 */       this.port = port;
...
/*  983 */     while (i >= 0 && addr[i] == -1) {
/*  984 */       addr[i] = 0;
/*  985 */       i--;
/*      */     } 
/*  988 */     Preconditions.checkArgument((i >= 0), "Incrementing %s would wrap.", new Object[] { address });
/*  990 */     addr[i] = (byte)(addr[i] + 1);
/*  991 */     return bytesToInetAddress(addr);
/*      */   }
/*      */   
/*      */   public static boolean isMaximum(InetAddress address) {
/* 1003 */     byte[] addr = address.getAddress();
/* 1004 */     for (int i = 0; i < addr.length; i++) {
/* 1005 */       if (addr[i] != -1)
/* 1006 */         return false; 
/*      */     } 
/* 1009 */     return true;
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\google\common\net\InetAddresses.class
