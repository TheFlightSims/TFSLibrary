...
/*  90 */     if (this.inError)
/*     */       return; 
/*  94 */     if (this.evaluator instanceof ch.qos.logback.core.spi.LifeCycle) {
...
/* 104 */       ec.popObject();
/*     */       try {
/* 107 */         Map<String, EventEvaluator<?>> evaluatorMap = (Map<String, EventEvaluator<?>>)this.context.getObject("EVALUATOR_MAP");
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\joran\action\AbstractEventEvaluatorAction.class
