...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TIntIntHashMap) {
/*  134 */       TIntIntHashMap hashmap = (TIntIntHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Integer, ? extends Integer> entry : map.entrySet())
/*  234 */       put(((Integer)entry.getKey()).intValue(), ((Integer)entry.getValue()).intValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TIntIntMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TIntIntIterator iter = map.iterator();
...
/*  393 */     return new TIntIntHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TIntIntHashMap.TIntIntKeyHashIterator((TPrimitiveHash)TIntIntHashMap.this);
/*      */     }
/*      */     
/*      */     public int getNoEntryValue() {
/*  521 */       return TIntIntHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TIntIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TIntIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(int entry) {
/*  539 */       return TIntIntHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public int[] toArray() {
/*  545 */       return TIntIntHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public int[] toArray(int[] dest) {
/*  551 */       return TIntIntHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TIntIntHashMap.this.no_entry_value != TIntIntHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TIntIntHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TIntIntHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TIntIntHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       int[] set = TIntIntHashMap.this._set;
/*  677 */       byte[] states = TIntIntHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TIntIntHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TIntIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TIntProcedure procedure) {
/*  742 */       return TIntIntHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TIntIntHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TIntIntHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TIntIntHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TIntIntHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TIntIntHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TIntIntHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TIntIntHashMap.this.forEachKey(new TIntProcedure() {
...
/*      */     public TIntIterator iterator() {
/*  807 */       return new TIntIntHashMap.TIntIntValueHashIterator((TPrimitiveHash)TIntIntHashMap.this);
/*      */     }
/*      */     
/*      */     public int getNoEntryValue() {
/*  813 */       return TIntIntHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TIntIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TIntIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(int entry) {
/*  831 */       return TIntIntHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public int[] toArray() {
/*  837 */       return TIntIntHashMap.this.values();
/*      */     }
/*      */     
/*      */     public int[] toArray(int[] dest) {
/*  843 */       return TIntIntHashMap.this.values(dest);
/*      */     }
/*      */     
/*      */     public boolean add(int entry) {
...
/*      */     
/*      */     public boolean remove(int entry) {
/*  855 */       int[] values = TIntIntHashMap.this._values;
/*  856 */       int[] set = TIntIntHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0 && set[i] != 2 && entry == values[i]) {
/*  860 */           TIntIntHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TIntIntHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TIntIntHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TIntIntHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       int[] values = TIntIntHashMap.this._values;
/*  962 */       byte[] states = TIntIntHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TIntIntHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TIntIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TIntProcedure procedure) {
/* 1027 */       return TIntIntHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TIntIntHashMap.this.forEachValue(new TIntProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TIntIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TIntIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TIntIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TIntIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public int key() {
/* 1148 */       return TIntIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public int value() {
/* 1153 */       return TIntIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public int setValue(int val) {
/* 1158 */       int old = value();
/* 1159 */       TIntIntHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TIntIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TIntIntMap))
/* 1185 */       return false; 
/* 1187 */     TIntIntMap that = (TIntIntMap)other;
...
/* 1230 */     forEachEntry(new TIntIntProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TIntIntHashMap.class
