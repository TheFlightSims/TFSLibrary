...
/*  63 */     Integer lastOp = this.lastOperation.get();
...
/* 102 */     Map<String, String> oldMap = this.copyOnInheritThreadLocal.get();
...
/* 118 */     if (key == null)
/*     */       return; 
/* 121 */     Map<String, String> oldMap = this.copyOnInheritThreadLocal.get();
/* 122 */     if (oldMap == null)
/*     */       return; 
...
/* 162 */     return this.copyOnInheritThreadLocal.get();
/*     */   }
/*     */   
...
/* 185 */     Map<String, String> hashMap = this.copyOnInheritThreadLocal.get();
/* 186 */     if (hashMap == null)
/* 187 */       return null; 
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\classi\\util\LogbackMDCAdapter.class
