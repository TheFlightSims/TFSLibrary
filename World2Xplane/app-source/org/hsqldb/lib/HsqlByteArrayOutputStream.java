...
public class HsqlByteArrayOutputStream extends OutputStream implements DataOutput {
  ...
  public HsqlByteArrayOutputStream(InputStream paramInputStream, int paramInt) throws IOException {
    this.buffer = new byte[paramInt];
  ...
  public HsqlByteArrayOutputStream(InputStream paramInputStream) throws IOException {
  ...
  public final void writeBytes(String paramString) {
    ...
    ensureRoom(i);
    for (byte b = 0; b < i; b++)
      this.buffer[this.count++] = (byte)paramString.charAt(b); 
  }
  ...
  public int write(InputStream paramInputStream, int paramInt) throws IOException {
    int i = paramInt;
    ensureRoom(paramInt);
    while (i > 0) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\lib\HsqlByteArrayOutputStream.class
