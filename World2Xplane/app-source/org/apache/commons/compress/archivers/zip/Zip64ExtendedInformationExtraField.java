...
/* 148 */     return new ZipShort(((this.size != null) ? 8 : 0) + ((this.compressedSize != null) ? 8 : 0) + ((this.relativeHeaderOffset != null) ? 8 : 0) + ((this.diskStart != null) ? 4 : 0));
/*     */   }
/*     */   
...
/* 254 */       int expectedLength = (hasUncompressedSize ? 8 : 0) + (hasCompressedSize ? 8 : 0) + (hasRelativeHeaderOffset ? 8 : 0) + (hasDiskStart ? 4 : 0);
/* 258 */       if (this.rawCentralDirectoryData.length != expectedLength)
/* 259 */         throw new ZipException("central directory zip64 extended information extra field's length doesn't match central directory data.  Expected length " + expectedLength + " but is " + this.rawCentralDirectoryData.length); 
/* 266 */       int offset = 0;
...
/* 272 */         this.compressedSize = new ZipEightByteInteger(this.rawCentralDirectoryData, offset);
/* 274 */         offset += 8;
/*     */       } 
/* 276 */       if (hasRelativeHeaderOffset) {
/* 277 */         this.relativeHeaderOffset = new ZipEightByteInteger(this.rawCentralDirectoryData, offset);
/* 279 */         offset += 8;
/*     */       } 
/* 281 */       if (hasDiskStart) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\compress\archivers\zip\Zip64ExtendedInformationExtraField.class
