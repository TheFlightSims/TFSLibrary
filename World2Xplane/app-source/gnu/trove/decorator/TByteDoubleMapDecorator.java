...
/* 187 */     return new AbstractSet<Map.Entry<Byte, Double>>() {
/*     */         public int size() {
/* 189 */           return TByteDoubleMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 193 */           return TByteDoubleMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 200 */             return (TByteDoubleMapDecorator.this.containsKey(k) && TByteDoubleMapDecorator.this.get(k).equals(v));
/*     */           } 
/* 203 */           return false;
/*     */         }
/*     */         
/*     */         public Iterator<Map.Entry<Byte, Double>> iterator() {
/* 208 */           return new Iterator<Map.Entry<Byte, Double>>() {
/* 209 */               private final TByteDoubleIterator it = TByteDoubleMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Byte, Double> next() {
/* 212 */                 this.it.advance();
/* 213 */                 byte ik = this.it.key();
/* 214 */                 final Byte key = (ik == TByteDoubleMapDecorator.this._map.getNoEntryKey()) ? null : TByteDoubleMapDecorator.this.wrapKey(ik);
/* 215 */                 double iv = this.it.value();
/* 216 */                 final Double v = (iv == TByteDoubleMapDecorator.this._map.getNoEntryValue()) ? null : TByteDoubleMapDecorator.this.wrapValue(iv);
/* 217 */                 return new Map.Entry<Byte, Double>() {
...
/* 239 */                       this.val = value;
/* 240 */                       return TByteDoubleMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 264 */             TByteDoubleMapDecorator.this._map.remove(TByteDoubleMapDecorator.this.unwrapKey(key));
/* 265 */             modified = true;
/*     */           } 
/* 267 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 275 */           TByteDoubleMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/* 332 */     Iterator<? extends Map.Entry<? extends Byte, ? extends Double>> it = map.entrySet().iterator();
/* 334 */     for (int i = map.size(); i-- > 0; ) {
/* 335 */       Map.Entry<? extends Byte, ? extends Double> e = it.next();
...
/* 390 */     in.readByte();
/* 393 */     this._map = (TByteDoubleMap)in.readObject();
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\decorator\TByteDoubleMapDecorator.class
