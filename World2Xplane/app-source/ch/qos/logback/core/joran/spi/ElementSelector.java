...
/* 125 */     int match = 0;
/* 127 */     for (int i = 0; i < minLen; ) {
/* 128 */       String l = this.partList.get(i);
/* 129 */       String r = p.partList.get(i);
/* 131 */       if (equalityCheck(l, r)) {
/* 132 */         match++;
/*     */         i++;
/*     */       } 
/*     */     } 
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\joran\spi\ElementSelector.class
