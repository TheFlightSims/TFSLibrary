...
class XSDComplexTypeTraverser extends XSDAbstractParticleTraverser {
  ...
  XSComplexTypeDecl traverseGlobal(Element paramElement, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar) {
    ...
    if (str == null) {
      ...
      paramSchemaGrammar.addGlobalTypeDecl((XSTypeDefinition)xSComplexTypeDecl);
    } 
    paramSchemaGrammar.addComplexTypeDecl(xSComplexTypeDecl, this.fSchemaHandler.element2Locator(paramElement));
    this.fAttrChecker.returnAttrArray(arrayOfObject, paramXSDocumentInfo);
    return xSComplexTypeDecl;
  ...
  private XSComplexTypeDecl traverseComplexTypeDecl(Element paramElement, String paramString, Object[] paramArrayOfObject, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar) {
    ...
    try {
      ...
      if (element == null) {
        this.fBaseType = (XSTypeDefinition)SchemaGrammar.fAnyType;
    ...
    this.fComplexTypeDecl.setValues(this.fName, this.fTargetNamespace, this.fBaseType, this.fDerivedBy, this.fFinal, this.fBlock, this.fContentType, this.fIsAbstract, this.fAttrGrp, this.fXSSimpleType, this.fParticle, new XSObjectListImpl((XSObject[])this.fAnnotations, (this.fAnnotations == null) ? 0 : this.fAnnotations.length));
  ...
  private void traverseSimpleContent(Element paramElement, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar) throws ComplexTypeRecoverableError {
    ...
    if (this.fDerivedBy == 2) {
      if (element1 != null && DOMUtil.getLocalName(element1).equals(SchemaSymbols.ELT_SIMPLETYPE)) {
        ...
        if (xSSimpleType != null && !XSConstraints.checkSimpleDerivationOk(xSSimpleType1, (XSTypeDefinition)xSSimpleType, xSSimpleType.getFinal())) {
          this.fAttrChecker.returnAttrArray(arrayOfObject1, paramXSDocumentInfo);
          this.fAttrChecker.returnAttrArray(arrayOfObject2, paramXSDocumentInfo);
      ...
      this.fXSSimpleType = this.schemaFactory.createTypeRestriction(null, paramXSDocumentInfo.fTargetNamespace, (short)0, xSSimpleType, null);
      try {
        this.fValidationState.setNamespaceSupport((NamespaceContext)paramXSDocumentInfo.fNamespaceSupport);
        this.fXSSimpleType.applyFacets(xSFacets, s1, s2, (ValidationContext)this.fValidationState);
  ...
  private void traverseComplexContent(Element paramElement, boolean paramBoolean, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar) throws ComplexTypeRecoverableError {
    ...
    this.fBaseType = (XSTypeDefinition)xSComplexTypeDecl;
  ...
  private void mergeAttributes(XSAttributeGroupDecl paramXSAttributeGroupDecl1, XSAttributeGroupDecl paramXSAttributeGroupDecl2, String paramString, boolean paramBoolean, Element paramElement) throws ComplexTypeRecoverableError {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      if (xSAttributeUse == null) {
        ...
        throw new ComplexTypeRecoverableError("ct-props-correct.4", new Object[] { paramString, xSAttributeUseImpl.fAttrDecl.getName() }, paramElement);
      } 
    } 
    if (paramBoolean)
  ...
  private void processComplexContent(Element paramElement, boolean paramBoolean1, boolean paramBoolean2, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar) throws ComplexTypeRecoverableError {
    ...
    if (paramElement != null) {
      ...
      if (str.equals(SchemaSymbols.ELT_GROUP)) {
        ...
        xSParticleDecl = traverseSequence(paramElement, paramXSDocumentInfo, paramSchemaGrammar, 0, (XSObject)this.fComplexTypeDecl);
        ...
        xSParticleDecl = traverseChoice(paramElement, paramXSDocumentInfo, paramSchemaGrammar, 0, (XSObject)this.fComplexTypeDecl);
        ...
        xSParticleDecl = traverseAll(paramElement, paramXSDocumentInfo, paramSchemaGrammar, 8, (XSObject)this.fComplexTypeDecl);
        if (xSParticleDecl != null) {
          XSModelGroupImpl xSModelGroupImpl = (XSModelGroupImpl)xSParticleDecl.fValue;
          if (xSModelGroupImpl.fParticleCount == 0)
            bool = true; 
    ...
    if (xSParticleDecl == null && paramBoolean1) {
      if (this.fEmptyParticle == null) {
        ...
        this.fEmptyParticle.fValue = (XSTerm)xSModelGroupImpl;
  ...
  private XSParticleDecl getErrorContent() {
    ...
    xSParticleDecl1.fValue = (XSTerm)getErrorWildcard();
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xs\traversers\XSDComplexTypeTraverser.class
