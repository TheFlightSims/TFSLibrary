...
/*  63 */       conditionAttribute = OptionHelper.substVars(conditionAttribute, (PropertyContainer)ic, (PropertyContainer)this.context);
/*  64 */       PropertyEvalScriptBuilder pesb = new PropertyEvalScriptBuilder((PropertyContainer)ic);
...
/*  83 */     IfState state = this.stack.pop();
/*  84 */     if (!state.active)
/*     */       return; 
...
/* 125 */     IfState state = this.stack.firstElement();
/* 126 */     if (state.active) {
...
/* 134 */     IfState state = this.stack.firstElement();
/* 135 */     if (state.active) {
...
/* 144 */     if (this.stack == null)
/* 144 */       return false; 
/* 145 */     if (this.stack.isEmpty())
/* 145 */       return false; 
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\joran\conditional\IfAction.class
