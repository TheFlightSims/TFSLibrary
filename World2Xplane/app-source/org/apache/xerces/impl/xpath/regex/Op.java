...
class Op {
  ...
  static class UnionOp extends Op {
    ...
    void addElement(Op param1Op) {
      this.branches.addElement(param1Op);
    }
    ...
    Op elementAt(int param1Int) {
      return this.branches.elementAt(param1Int);
    }
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xpath\regex\Op.class
