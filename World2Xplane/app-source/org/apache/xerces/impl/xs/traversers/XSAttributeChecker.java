...
public class XSAttributeChecker {
  ...
  public Object[] checkAttributes(Element paramElement, boolean paramBoolean1, XSDocumentInfo paramXSDocumentInfo, boolean paramBoolean2) {
    ...
    Container container = (Container)hashtable.get(str3);
    if (container == null) {
          ...
          try {
            if (oneAttr.dvIndex >= 0) {
              if (oneAttr.dvIndex != 3 && oneAttr.dvIndex != 6 && oneAttr.dvIndex != 7) {
                ...
                Object object = xSSimpleType.validate(str6, (ValidationContext)paramXSDocumentInfo.fValidationContext, null);
    ...
    for (byte b2 = 0; b2 < arrayOfOneAttr.length; b2++) {
      OneAttr oneAttr = arrayOfOneAttr[b2];
    ...
    if (arrayOfObject[ATTIDX_MAXOCCURS] != null) {
      int j = ((XInt)arrayOfObject[ATTIDX_MINOCCURS]).intValue();
    ...
    switch (paramInt) {
      ...
      case -9:
        ...
        try {
          ...
          while (stringTokenizer1.hasMoreTokens()) {
            String str1 = stringTokenizer1.nextToken();
            QName qName = (QName)fExtraDVs[2].validate(str1, (ValidationContext)paramXSDocumentInfo.fValidationContext, null);
            if (qName.prefix == XMLSymbols.EMPTY_STRING && qName.uri == null && paramXSDocumentInfo.fIsChameleonSchema)
              qName.uri = paramXSDocumentInfo.fTargetNamespace; 
      ...
      case -11:
        ...
        try {
          while (stringTokenizer.hasMoreTokens()) {
            ...
            if (str1.equals("##local")) {
              ...
              fExtraDVs[0].validate(str1, (ValidationContext)paramXSDocumentInfo.fValidationContext, null);
        ...
        j = this.fNamespaceList.size();
        arrayOfString = new String[j];
        this.fNamespaceList.copyInto((Object[])arrayOfString);
  ...
  public void checkNonSchemaAttributes(XSGrammarBucket paramXSGrammarBucket) {
    ...
    while (enumeration.hasMoreElements()) {
      ...
      if (xSSimpleType == null)
        continue; 
      Vector vector = (Vector)this.fNonSchemaAttrs.get(str1);
      String str4 = vector.elementAt(0);
      int i = vector.size();
      for (byte b = 1; b < i; b += 2) {
        String str = vector.elementAt(b);
        try {
          xSSimpleType.validate(vector.elementAt(b + 1), null, null);
        } catch (InvalidDatatypeValueException invalidDatatypeValueException) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xs\traversers\XSAttributeChecker.class
