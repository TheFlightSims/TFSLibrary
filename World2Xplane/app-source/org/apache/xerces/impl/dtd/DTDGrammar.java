...
public class DTDGrammar implements XMLDTDHandler, XMLDTDContentModelHandler, EntityState, Grammar {
  ...
  public void internalEntityDecl(String paramString, XMLString paramXMLString1, XMLString paramXMLString2, Augmentations paramAugmentations) throws XNIException {
    ...
    if (i == -1) {
      ...
      boolean bool1 = (this.fReadingExternalDTD || this.fPEDepth > 0) ? true : false;
      XMLEntityDecl xMLEntityDecl = new XMLEntityDecl();
      xMLEntityDecl.setValues(paramString, null, null, null, null, paramXMLString1.toString(), bool, bool1);
  ...
  public void externalEntityDecl(String paramString, XMLResourceIdentifier paramXMLResourceIdentifier, Augmentations paramAugmentations) throws XNIException {
    ...
    if (i == -1) {
      ...
      boolean bool1 = (this.fReadingExternalDTD || this.fPEDepth > 0) ? true : false;
      XMLEntityDecl xMLEntityDecl = new XMLEntityDecl();
      xMLEntityDecl.setValues(paramString, paramXMLResourceIdentifier.getPublicId(), paramXMLResourceIdentifier.getLiteralSystemId(), paramXMLResourceIdentifier.getBaseSystemId(), null, null, bool, bool1);
      setEntityDecl(i, xMLEntityDecl);
    } 
  }
  ...
  public void unparsedEntityDecl(String paramString1, XMLResourceIdentifier paramXMLResourceIdentifier, String paramString2, Augmentations paramAugmentations) throws XNIException {
    ...
    boolean bool1 = (this.fReadingExternalDTD || this.fPEDepth > 0) ? true : false;
    xMLEntityDecl.setValues(paramString1, paramXMLResourceIdentifier.getPublicId(), paramXMLResourceIdentifier.getLiteralSystemId(), paramXMLResourceIdentifier.getBaseSystemId(), paramString2, null, bool, bool1);
  ...
  public void endDTD(Augmentations paramAugmentations) throws XNIException {
    ...
    if (this.fGrammarDescription.getRootName() == null) {
      ...
      for (byte b = 0; b < this.fElementDeclCount; b++) {
        int j = b >> 8;
        i = b & 0xFF;
        str = (this.fElementDeclName[j][i]).rawname;
  ...
  public boolean getAttributeDecl(int paramInt, XMLAttributeDecl paramXMLAttributeDecl) {
    ...
    if (this.fAttributeDeclType[i][j] == -1) {
      ...
      bool = ((this.fAttributeDeclType[i][j] & 0x80) != 0) ? true : false;
    } 
  ...
  public int getEntityDeclIndex(String paramString) {
    return (paramString == null) ? -1 : this.fEntityIndexMap.get(paramString);
  }
  ...
  public int getNotationDeclIndex(String paramString) {
    return (paramString == null) ? -1 : this.fNotationIndexMap.get(paramString);
  }
      ...
      switch (m) {
        ...
        case 1:
          ...
          if (s == 0) {
            ...
            stringBuffer.append('(');
            appendContentSpec(xMLContentSpec, stringBuffer, true, m);
            stringBuffer.append(')');
          } else {
            appendContentSpec(xMLContentSpec, stringBuffer, true, m);
          } 
  ...
  protected ContentModelValidator getElementContentModelValidator(int paramInt) {
    ...
    if (s == 2) {
      ...
      MixedContentModel mixedContentModel = new MixedContentModel(childrenList.qname, childrenList.type, 0, childrenList.length, false);
    } else if (s == 3) {
  ...
  private void appendContentSpec(XMLContentSpec paramXMLContentSpec, StringBuffer paramStringBuffer, boolean paramBoolean, int paramInt) {
    ...
    switch (i) {
      ...
      case 5:
        if (paramBoolean)
          paramStringBuffer.append('('); 
        s = paramXMLContentSpec.type;
        j = ((int[])paramXMLContentSpec.otherValue)[0];
        getContentSpec(((int[])paramXMLContentSpec.value)[0], paramXMLContentSpec);
        appendContentSpec(paramXMLContentSpec, paramStringBuffer, (paramXMLContentSpec.type != s), i);
        if (s == 4) {
          paramStringBuffer.append('|');
        } else {
          paramStringBuffer.append(',');
        } 
        getContentSpec(j, paramXMLContentSpec);
        appendContentSpec(paramXMLContentSpec, paramStringBuffer, true, i);
        if (paramBoolean)
          paramStringBuffer.append(')'); 
        return;
  ...
  private synchronized ContentModelValidator createChildModel(int paramInt) {
    ...
    if ((xMLContentSpec.type & 0xF) != 6 && (xMLContentSpec.type & 0xF) != 7 && (xMLContentSpec.type & 0xF) != 8) {
      if (xMLContentSpec.type == 0) {
        ...
        return (ContentModelValidator)new SimpleContentModel(xMLContentSpec.type, this.fQName, null);
      } 
      if (xMLContentSpec.type == 4 || xMLContentSpec.type == 5) {
        ...
        if (xMLContentSpec1.type == 0 && xMLContentSpec2.type == 0) {
          ...
          return (ContentModelValidator)new SimpleContentModel(xMLContentSpec.type, this.fQName, this.fQName2);
        } 
    ...
    return (ContentModelValidator)new DFAContentModel(cMNode, this.fLeafCount, false);
  }
  ...
  private final CMNode buildSyntaxTree(int paramInt, XMLContentSpec paramXMLContentSpec) {
    ...
    if ((paramXMLContentSpec.type & 0xF) == 6) {
      cMAny = new CMAny(paramXMLContentSpec.type, (String)paramXMLContentSpec.otherValue, this.fLeafCount++);
    } else if ((paramXMLContentSpec.type & 0xF) == 7) {
      cMAny = new CMAny(paramXMLContentSpec.type, (String)paramXMLContentSpec.otherValue, this.fLeafCount++);
    } else if ((paramXMLContentSpec.type & 0xF) == 8) {
      cMAny = new CMAny(paramXMLContentSpec.type, null, this.fLeafCount++);
  ...
  private void contentSpecTree(int paramInt, XMLContentSpec paramXMLContentSpec, ChildrenList paramChildrenList) {
    ...
    boolean bool = (paramXMLContentSpec.value != null) ? ((int[])paramXMLContentSpec.value)[0] : true;
    int i = -1;
    if (paramXMLContentSpec.otherValue != null) {
    ...
    if (paramXMLContentSpec.type == 4 || paramXMLContentSpec.type == 5) {
      contentSpecTree(bool, paramXMLContentSpec, paramChildrenList);
  ...
  protected static final class QNameHashtable {
    ...
    public void put(String param1String, int param1Int) {
      int i = (param1String.hashCode() & Integer.MAX_VALUE) % 101;
      Object[] arrayOfObject = this.fHashTable[i];
      if (arrayOfObject == null) {
        arrayOfObject = new Object[9];
        (new int[1])[0] = 1;
        arrayOfObject[0] = new int[1];
        arrayOfObject[1] = param1String;
        (new int[1])[0] = param1Int;
        arrayOfObject[2] = new int[1];
        this.fHashTable[i] = arrayOfObject;
      } else {
        int j = ((int[])arrayOfObject[0])[0];
        int k = 1 + 2 * j;
        if (k == arrayOfObject.length) {
          int m = j + 4;
          Object[] arrayOfObject1 = new Object[1 + 2 * m];
          System.arraycopy(arrayOfObject, 0, arrayOfObject1, 0, k);
        ...
        for (byte b2 = 0; b2 < j; b2++) {
          if ((String)arrayOfObject[b1] == param1String) {
            ((int[])arrayOfObject[b1 + 1])[0] = param1Int;
            bool = true;
            break;
          } 
          b1 += 2;
        ...
        if (!bool) {
          arrayOfObject[k++] = param1String;
          (new int[1])[0] = param1Int;
          arrayOfObject[k] = new int[1];
          ((int[])arrayOfObject[0])[0] = ++j;
        } 
      } 
    }
    
    public int get(String param1String) {
      int i = (param1String.hashCode() & Integer.MAX_VALUE) % 101;
      Object[] arrayOfObject = this.fHashTable[i];
      if (arrayOfObject == null)
        return -1; 
      ...
      for (byte b2 = 0; b2 < j; b2++) {
        if ((String)arrayOfObject[b1] == param1String)
          return ((int[])arrayOfObject[b1 + 1])[0]; 
        b1 += 2;
      } 
      return -1;
    }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\dtd\DTDGrammar.class
