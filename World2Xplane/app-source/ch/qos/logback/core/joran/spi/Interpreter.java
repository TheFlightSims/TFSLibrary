...
/* 169 */     List<Action> applicableActionList = this.actionListStack.peek();
/* 171 */     if (body != null) {
/* 172 */       body = body.trim();
...
/* 189 */     List<Action> applicableActionList = this.actionListStack.pop();
...
/* 235 */       ImplicitAction ia = this.implicitActions.get(i);
/* 237 */       if (ia.isApplicable(elementPath, attributes, ec)) {
/* 238 */         List<Action> actionList = new ArrayList<Action>(1);
...
/* 292 */     while (i.hasNext()) {
/* 293 */       Action action = i.next();
/*     */       try {
/* 295 */         action.body(this.interpretationContext, body);
/* 296 */       } catch (ActionException ae) {
...
/* 312 */     while (i.hasNext()) {
/* 313 */       Action action = i.next();
/*     */       try {
/* 317 */         action.end(this.interpretationContext, tagName);
/* 318 */       } catch (ActionException ae) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\joran\spi\Interpreter.class
