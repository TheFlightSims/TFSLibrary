...
class RegexParser {
  ...
  synchronized Token parse(String paramString, int paramInt) throws ParseException {
    ...
    if (this.references != null) {
      for (byte b = 0; b < this.references.size(); b++) {
        ReferencePosition referencePosition = this.references.elementAt(b);
  ...
  Token processBackreference() throws ParseException {
    ...
    Token.StringToken stringToken = Token.createBackReference(i);
    this.hasBackReferences = true;
    if (this.references == null)
      this.references = new Vector(); 
  ...
  protected RangeToken processBacksolidus_pP(int paramInt) throws ParseException {
    ...
    boolean bool = (paramInt == 112) ? true : false;
    int i = this.offset;
  ...
  protected RangeToken parseCharacterClass(boolean paramBoolean) throws ParseException {
    ...
    boolean bool2 = true;
    int i;
    while ((i = read()) != 1 && (i != 0 || this.chardata != 93 || bool2)) {
      bool2 = false;
      int j = this.chardata;
      boolean bool = false;
      if (i == 10) {
  ...
  private static final int hexChar(int paramInt) {
    return (paramInt < 48) ? -1 : ((paramInt > 102) ? -1 : ((paramInt <= 57) ? (paramInt - 48) : ((paramInt < 65) ? -1 : ((paramInt <= 70) ? (paramInt - 65 + 10) : ((paramInt < 97) ? -1 : (paramInt - 97 + 10))))));
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xpath\regex\RegexParser.class
