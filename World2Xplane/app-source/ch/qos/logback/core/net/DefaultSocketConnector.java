...
/*     */   
/*     */   public DefaultSocketConnector(InetAddress address, int port, int initialDelay, int retryDelay) {
/*  50 */     this(address, port, (DelayStrategy)new FixedDelay(initialDelay, retryDelay));
/*     */   }
/*     */   
...
/*  93 */       this.exceptionHandler = new ConsoleExceptionHandler(); 
