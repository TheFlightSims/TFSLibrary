...
/*  77 */       errors++;
/*     */     } else {
/*  79 */       this.appenderTracker = new AppenderTracker<E>(this.context, this.appenderFactory);
...
/*     */   
/*     */   public void stop() {
/*  90 */     for (Appender<E> appender : (Iterable<Appender<E>>)this.appenderTracker.allComponents())
/*  91 */       appender.stop(); 
/*     */   }
/*     */   
...
/* 105 */     Appender<E> appender = (Appender<E>)this.appenderTracker.getOrCreate(discriminatingValue, timestamp);
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\sift\SiftingAppenderBase.class
