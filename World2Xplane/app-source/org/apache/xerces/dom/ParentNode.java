...
public abstract class ParentNode extends ChildNode {
  ...
  Node internalInsertBefore(Node paramNode1, Node paramNode2, boolean paramBoolean) throws DOMException {
    ...
    if (bool) {
      ...
      while (bool1 && parentNode != null) {
        bool1 = (paramNode1 != parentNode) ? true : false;
  ...
  protected final NodeList getChildNodesUnoptimized() {
    ...
    return new NodeList(this) {
        ...
        public Node item(int param1Int) {
          return this.this$0.nodeListItem(param1Int);
        }
      };
  }
  ...
  class UserDataRecord implements Serializable {
    ...
    UserDataRecord(ParentNode this$0, Object param1Object, UserDataHandler param1UserDataHandler) {
      this.this$0 = this$0;
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\ParentNode.class
