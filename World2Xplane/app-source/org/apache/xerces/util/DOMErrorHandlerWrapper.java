...
public class DOMErrorHandlerWrapper implements XMLErrorHandler, DOMErrorHandler {
  ...
  public void warning(String paramString1, String paramString2, XMLParseException paramXMLParseException) throws XNIException {
    ...
    this.fDOMError.fException = (Exception)paramXMLParseException;
  ...
  private static class DOMErrorTypeMap {
    ...
    public static String getDOMErrorType(XMLErrorCode param1XMLErrorCode) {
      return (String)fgDOMErrorTypeTable.get(param1XMLErrorCode);
    }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerce\\util\DOMErrorHandlerWrapper.class
