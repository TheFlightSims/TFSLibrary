...
/*  68 */       return "0x" + Integer.toHexString(Character.MAX_VALUE & this.unicode) + "->0x" + Integer.toHexString(0xFF & this.code);
/*     */     }
/*     */     
...
/* 106 */     List<Simple8BitChar> temp = new ArrayList<Simple8BitChar>(this.highChars.length);
/* 109 */     byte code = Byte.MAX_VALUE;
/* 111 */     for (int i = 0; i < this.highChars.length; i++) {
/* 112 */       code = (byte)(code + 1);
/* 112 */       temp.add(new Simple8BitChar(code, this.highChars[i]));
/*     */     } 
...
/* 189 */       Simple8BitChar m = this.reverseMapping.get(i);
/* 191 */       if (m.unicode == c)
/* 192 */         return m; 
/* 195 */       if (m.unicode < c) {
/* 196 */         i0 = i + 1;
...
/* 203 */       return null; 
/* 206 */     Simple8BitChar r = this.reverseMapping.get(i0);
/* 208 */     if (r.unicode != c)
/* 209 */       return null; 
/* 212 */     return r;
/*     */   }
...
/* 238 */     ByteBuffer out = ByteBuffer.allocate(name.length() + 6 + (name.length() + 1) / 2);
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\compress\archivers\zip\Simple8BitZipEncoding.class
