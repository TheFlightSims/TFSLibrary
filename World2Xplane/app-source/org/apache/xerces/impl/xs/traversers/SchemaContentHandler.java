...
final class SchemaContentHandler implements ContentHandler {
  ...
  public void startDocument() throws SAXException {
    ...
    try {
      this.fSchemaDOMParser.startDocument((XMLLocator)this.fSAXLocatorWrapper, null, (NamespaceContext)this.fNamespaceContext, null);
  ...
  private void addNamespaceDeclarations(int paramInt) {
    ...
    for (byte b = 0; b < paramInt; b++) {
      ...
      if (str4.length() > 0) {
        ...
        str3 = this.fSymbolTable.addSymbol(((XMLString)this.fStringBuffer).ch, ((XMLString)this.fStringBuffer).offset, ((XMLString)this.fStringBuffer).length);
      } else {
      ...
      this.fAttributes.addAttribute(this.fAttributeQName, XMLSymbols.fCDATASymbol, str5);
    } 
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xs\traversers\SchemaContentHandler.class
