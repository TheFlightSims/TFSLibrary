...
public final class REUtil {
  ...
  static final String substring(CharacterIterator paramCharacterIterator, int paramInt1, int paramInt2) {
    ...
    for (byte b = 0; b < arrayOfChar.length; b++)
      arrayOfChar[b] = paramCharacterIterator.setIndex(b + paramInt1); 
    return new String(arrayOfChar);
  }
    ...
    for (byte b = 0; b < i; b++) {
      ...
      if (".*+?{[()|\\^$".indexOf(c) >= 0) {
        if (stringBuffer == null) {
          stringBuffer = new StringBuffer(b + (i - b) * 2);
          if (b > 0)
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xpath\regex\REUtil.class
