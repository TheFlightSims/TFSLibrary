...
/* 127 */     if (collection instanceof TIntHashSet) {
/* 128 */       TIntHashSet hashset = (TIntHashSet)collection;
...
/* 155 */     return new TIntHashIterator(this);
/*     */   }
/*     */   
/*     */   public int[] toArray() {
/* 161 */     int[] result = new int[size()];
/* 162 */     int[] set = this._set;
...
/* 220 */       if (element instanceof Integer) {
/* 221 */         int c = ((Integer)element).intValue();
/* 222 */         if (!contains(c))
/* 223 */           return false; 
/*     */         continue;
/*     */       } 
...
/* 236 */     TIntIterator iter = collection.iterator();
/* 237 */     while (iter.hasNext()) {
/* 238 */       int element = iter.next();
...
/* 261 */     for (Integer element : collection) {
/* 262 */       int e = element.intValue();
/* 263 */       if (add(e))
/* 264 */         changed = true; 
/*     */     } 
/* 267 */     return changed;
...
/* 274 */     TIntIterator iter = collection.iterator();
/* 275 */     while (iter.hasNext()) {
/* 276 */       int element = iter.next();
/* 277 */       if (add(element))
/* 278 */         changed = true; 
/*     */     } 
/* 281 */     return changed;
...
/* 301 */     TIntIterator iter = iterator();
/* 302 */     while (iter.hasNext()) {
/* 303 */       if (!collection.contains(Integer.valueOf(iter.next()))) {
/* 304 */         iter.remove();
/* 305 */         modified = true;
/*     */       } 
/*     */     } 
...
/* 318 */     TIntIterator iter = iterator();
...
/* 353 */       if (element instanceof Integer) {
/* 354 */         int c = ((Integer)element).intValue();
/* 355 */         if (remove(c))
/* 356 */           changed = true; 
/*     */       } 
/*     */     } 
...
/* 367 */     TIntIterator iter = collection.iterator();
/* 368 */     while (iter.hasNext()) {
/* 369 */       int element = iter.next();
...
/* 407 */     int[] oldSet = this._set;
/* 408 */     byte[] oldStates = this._states;
/* 410 */     this._set = new int[newCapacity];
...
/* 424 */     if (!(other instanceof TIntSet))
/* 425 */       return false; 
/* 427 */     TIntSet that = (TIntSet)other;
...
/* 506 */     out.writeInt(this.no_entry_value);
/* 509 */     for (int i = this._states.length; i-- > 0;) {
/* 510 */       if (this._states[i] == 1)
/* 511 */         out.writeInt(this._set[i]); 
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\set\hash\TIntHashSet.class
