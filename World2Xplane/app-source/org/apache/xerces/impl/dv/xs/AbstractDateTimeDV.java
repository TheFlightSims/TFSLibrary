...
public abstract class AbstractDateTimeDV extends TypeValidator {
  ...
  protected final DatatypeFactory factory = (DatatypeFactory)new DatatypeFactoryImpl();
  ...
  public boolean isIdentical(Object paramObject1, Object paramObject2) {
    ...
    return (dateTimeData1.timezoneHr == dateTimeData2.timezoneHr && dateTimeData1.timezoneMin == dateTimeData2.timezoneMin) ? dateTimeData1.equals(dateTimeData2) : false;
  }
  ...
  protected void getTimeZone(String paramString, DateTimeData paramDateTimeData, int paramInt1, int paramInt2) throws RuntimeException {
    ...
    if (paramInt1 <= paramInt2 - 6) {
      byte b = (paramString.charAt(paramInt1) == '-') ? -1 : 1;
      int i = ++paramInt1 + 2;
      paramDateTimeData.timezoneHr = b * parseInt(paramString, paramInt1, i);
      if (paramString.charAt(i++) != ':')
        throw new RuntimeException("Error in parsing time zone"); 
      paramDateTimeData.timezoneMin = b * parseInt(paramString, i, i + 2);
      if (i + 2 != paramInt2)
        throw new RuntimeException("Error in parsing time zone"); 
  ...
  protected int parseInt(String paramString, int paramInt1, int paramInt2) throws NumberFormatException {
    byte b = 10;
    int i = 0;
    int j = 0;
    int k = -2147483647;
    ...
    int n = paramInt1;
    while (true) {
      j = TypeValidator.getDigit(paramString.charAt(n));
      if (j < 0)
  ...
  protected int parseIntYear(String paramString, int paramInt) {
    ...
    int k = j / b1;
    while (b2 < paramInt) {
      m = TypeValidator.getDigit(paramString.charAt(b2++));
      if (m < 0)
        throw new NumberFormatException("'" + paramString + "' has wrong format"); 
      if (i < k)
        throw new NumberFormatException("'" + paramString + "' has wrong format"); 
  ...
  protected void normalize(DateTimeData paramDateTimeData) {
    byte b = -1;
    int i = paramDateTimeData.minute + b * paramDateTimeData.timezoneMin;
    int j = fQuotient(i, 60);
    paramDateTimeData.minute = mod(i, 60, j);
    i = paramDateTimeData.hour + b * paramDateTimeData.timezoneHr + j;
    j = fQuotient(i, 24);
    paramDateTimeData.hour = mod(i, 24, j);
    paramDateTimeData.day += j;
    while (true) {
      i = maxDayInMonthFor(paramDateTimeData.year, paramDateTimeData.month);
      if (paramDateTimeData.day < 1) {
        paramDateTimeData.day += maxDayInMonthFor(paramDateTimeData.year, paramDateTimeData.month - 1);
        j = -1;
      } else if (paramDateTimeData.day > i) {
        paramDateTimeData.day -= i;
        j = 1;
      } else {
        paramDateTimeData.utc = 90;
        return;
      } 
      i = paramDateTimeData.month + j;
      paramDateTimeData.month = modulo(i, 1, 13);
      paramDateTimeData.year += fQuotient(i, 1, 13);
      if (paramDateTimeData.year == 0)
  ...
  protected int maxDayInMonthFor(int paramInt1, int paramInt2) {
    return (paramInt2 == 4 || paramInt2 == 6 || paramInt2 == 9 || paramInt2 == 11) ? 30 : ((paramInt2 == 2) ? (isLeapYear(paramInt1) ? 29 : 28) : 31);
  }
  ...
  static final class DateTimeData implements XSDateTime {
    ...
    public boolean equals(Object param1Object) {
      return !(param1Object instanceof DateTimeData) ? false : ((this.type.compareDates(this, (DateTimeData)param1Object, true) == 0));
    }
    ...
    public int getYears() {
      return (this.type instanceof DurationDV) ? 0 : (this.normalized ? this.year : this.unNormYear);
    }
    ...
    public int getDays() {
      return (this.type instanceof DurationDV) ? 0 : (this.normalized ? this.day : this.unNormDay);
    }
    
    public int getHours() {
      return (this.type instanceof DurationDV) ? 0 : (this.normalized ? this.hour : this.unNormHour);
    }
    
    public int getMinutes() {
      return (this.type instanceof DurationDV) ? 0 : (this.normalized ? this.minute : this.unNormMinute);
    }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\dv\xs\AbstractDateTimeDV.class
