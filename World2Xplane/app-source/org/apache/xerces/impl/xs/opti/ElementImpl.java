...
public class ElementImpl extends DefaultElement {
  ...
  public String getAttributeNS(String paramString1, String paramString2) {
    for (byte b = 0; b < this.attrs.length; b++) {
      if (this.attrs[b].getLocalName().equals(paramString2) && this.attrs[b].getNamespaceURI().equals(paramString1))
        return this.attrs[b].getValue(); 
    } 
    return "";
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xs\opti\ElementImpl.class
