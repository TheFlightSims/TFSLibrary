...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TDoubleLongHashMap) {
/*  134 */       TDoubleLongHashMap hashmap = (TDoubleLongHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Double, ? extends Long> entry : map.entrySet())
/*  234 */       put(((Double)entry.getKey()).doubleValue(), ((Long)entry.getValue()).longValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TDoubleLongMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TDoubleLongIterator iter = map.iterator();
...
/*  393 */     return new TDoubleLongHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TDoubleLongHashMap.TDoubleLongKeyHashIterator((TPrimitiveHash)TDoubleLongHashMap.this);
/*      */     }
/*      */     
/*      */     public double getNoEntryValue() {
/*  521 */       return TDoubleLongHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TDoubleLongHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TDoubleLongHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(double entry) {
/*  539 */       return TDoubleLongHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public double[] toArray() {
/*  545 */       return TDoubleLongHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public double[] toArray(double[] dest) {
/*  551 */       return TDoubleLongHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TDoubleLongHashMap.this.no_entry_value != TDoubleLongHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TDoubleLongHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TDoubleLongHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TDoubleLongHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       double[] set = TDoubleLongHashMap.this._set;
/*  677 */       byte[] states = TDoubleLongHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TDoubleLongHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TDoubleLongHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TDoubleProcedure procedure) {
/*  742 */       return TDoubleLongHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TDoubleLongHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TDoubleLongHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TDoubleLongHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TDoubleLongHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TDoubleLongHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TDoubleLongHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TDoubleLongHashMap.this.forEachKey(new TDoubleProcedure() {
...
/*  807 */       return new TDoubleLongHashMap.TDoubleLongValueHashIterator((TPrimitiveHash)TDoubleLongHashMap.this);
/*      */     }
/*      */     
/*      */     public long getNoEntryValue() {
/*  813 */       return TDoubleLongHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TDoubleLongHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TDoubleLongHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(long entry) {
/*  831 */       return TDoubleLongHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public long[] toArray() {
/*  837 */       return TDoubleLongHashMap.this.values();
/*      */     }
/*      */     
/*      */     public long[] toArray(long[] dest) {
/*  843 */       return TDoubleLongHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       long[] values = TDoubleLongHashMap.this._values;
/*  856 */       double[] set = TDoubleLongHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0.0D && set[i] != 2.0D && entry == values[i]) {
/*  860 */           TDoubleLongHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TDoubleLongHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TDoubleLongHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TDoubleLongHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       long[] values = TDoubleLongHashMap.this._values;
/*  962 */       byte[] states = TDoubleLongHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TDoubleLongHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TDoubleLongHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TLongProcedure procedure) {
/* 1027 */       return TDoubleLongHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TDoubleLongHashMap.this.forEachValue(new TLongProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TDoubleLongHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TDoubleLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TDoubleLongHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TDoubleLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public double key() {
/* 1148 */       return TDoubleLongHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public long value() {
/* 1153 */       return TDoubleLongHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public long setValue(long val) {
/* 1158 */       long old = value();
/* 1159 */       TDoubleLongHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TDoubleLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TDoubleLongMap))
/* 1185 */       return false; 
/* 1187 */     TDoubleLongMap that = (TDoubleLongMap)other;
...
/* 1230 */     forEachEntry(new TDoubleLongProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TDoubleLongHashMap.class
