...
/*    */   
/*    */   public enum Type {
/* 23 */     LITERAL, START, CURLY_LEFT, CURLY_RIGHT, DEFAULT;
/*    */   }
/*    */   
...
/* 40 */     if (this.type != token.type)
/* 40 */       return false; 
/* 41 */     if ((this.payload != null) ? !this.payload.equals(token.payload) : (token.payload != null))
/* 41 */       return false; 
/* 43 */     return true;
/*    */   }
/*    */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\subst\Token.class
