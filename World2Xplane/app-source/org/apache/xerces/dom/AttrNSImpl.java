...
public class AttrNSImpl extends AttrImpl {
  ...
  public String getTypeName() {
    return (this.type != null) ? ((this.type instanceof XSSimpleTypeDecl) ? ((XSSimpleTypeDecl)this.type).getName() : (String)this.type) : null;
  }
  
  public boolean isDerivedFrom(String paramString1, String paramString2, int paramInt) {
    return (this.type != null && this.type instanceof org.apache.xerces.xs.XSSimpleTypeDefinition) ? ((XSSimpleTypeDecl)this.type).isDOMDerivedFrom(paramString1, paramString2, paramInt) : false;
  }
  
  public String getTypeNamespace() {
    return (this.type != null) ? ((this.type instanceof XSSimpleTypeDecl) ? ((XSSimpleTypeDecl)this.type).getNamespace() : "http://www.w3.org/TR/REC-xml") : null;
  }
}


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\AttrNSImpl.class
