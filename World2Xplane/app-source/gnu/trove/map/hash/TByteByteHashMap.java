...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TByteByteHashMap) {
/*  134 */       TByteByteHashMap hashmap = (TByteByteHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Byte, ? extends Byte> entry : map.entrySet())
/*  234 */       put(((Byte)entry.getKey()).byteValue(), ((Byte)entry.getValue()).byteValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TByteByteMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TByteByteIterator iter = map.iterator();
...
/*  393 */     return new TByteByteHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TByteByteHashMap.TByteByteKeyHashIterator((TPrimitiveHash)TByteByteHashMap.this);
/*      */     }
/*      */     
/*      */     public byte getNoEntryValue() {
/*  521 */       return TByteByteHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TByteByteHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TByteByteHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(byte entry) {
/*  539 */       return TByteByteHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public byte[] toArray() {
/*  545 */       return TByteByteHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public byte[] toArray(byte[] dest) {
/*  551 */       return TByteByteHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TByteByteHashMap.this.no_entry_value != TByteByteHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TByteByteHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TByteByteHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TByteByteHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       byte[] set = TByteByteHashMap.this._set;
/*  677 */       byte[] states = TByteByteHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TByteByteHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TByteByteHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TByteProcedure procedure) {
/*  742 */       return TByteByteHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TByteByteHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TByteByteHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TByteByteHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TByteByteHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TByteByteHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TByteByteHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TByteByteHashMap.this.forEachKey(new TByteProcedure() {
...
/*      */     public TByteIterator iterator() {
/*  807 */       return new TByteByteHashMap.TByteByteValueHashIterator((TPrimitiveHash)TByteByteHashMap.this);
/*      */     }
/*      */     
/*      */     public byte getNoEntryValue() {
/*  813 */       return TByteByteHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TByteByteHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TByteByteHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(byte entry) {
/*  831 */       return TByteByteHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public byte[] toArray() {
/*  837 */       return TByteByteHashMap.this.values();
/*      */     }
/*      */     
/*      */     public byte[] toArray(byte[] dest) {
/*  843 */       return TByteByteHashMap.this.values(dest);
/*      */     }
/*      */     
/*      */     public boolean add(byte entry) {
...
/*      */     
/*      */     public boolean remove(byte entry) {
/*  855 */       byte[] values = TByteByteHashMap.this._values;
/*  856 */       byte[] set = TByteByteHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0 && set[i] != 2 && entry == values[i]) {
/*  860 */           TByteByteHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TByteByteHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TByteByteHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TByteByteHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       byte[] values = TByteByteHashMap.this._values;
/*  962 */       byte[] states = TByteByteHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TByteByteHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TByteByteHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TByteProcedure procedure) {
/* 1027 */       return TByteByteHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TByteByteHashMap.this.forEachValue(new TByteProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TByteByteHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TByteByteHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TByteByteHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TByteByteHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public byte key() {
/* 1148 */       return TByteByteHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public byte value() {
/* 1153 */       return TByteByteHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte val) {
/* 1158 */       byte old = value();
/* 1159 */       TByteByteHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TByteByteHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TByteByteMap))
/* 1185 */       return false; 
/* 1187 */     TByteByteMap that = (TByteByteMap)other;
...
/* 1230 */     forEachEntry(new TByteByteProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TByteByteHashMap.class
