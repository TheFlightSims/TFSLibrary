...
/* 187 */     return new AbstractSet<Map.Entry<Double, Float>>() {
/*     */         public int size() {
/* 189 */           return TDoubleFloatMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 193 */           return TDoubleFloatMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 200 */             return (TDoubleFloatMapDecorator.this.containsKey(k) && TDoubleFloatMapDecorator.this.get(k).equals(v));
/*     */           } 
/* 203 */           return false;
/*     */         }
/*     */         
/*     */         public Iterator<Map.Entry<Double, Float>> iterator() {
/* 208 */           return new Iterator<Map.Entry<Double, Float>>() {
/* 209 */               private final TDoubleFloatIterator it = TDoubleFloatMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Double, Float> next() {
/* 212 */                 this.it.advance();
/* 213 */                 double ik = this.it.key();
/* 214 */                 final Double key = (ik == TDoubleFloatMapDecorator.this._map.getNoEntryKey()) ? null : TDoubleFloatMapDecorator.this.wrapKey(ik);
/* 215 */                 float iv = this.it.value();
/* 216 */                 final Float v = (iv == TDoubleFloatMapDecorator.this._map.getNoEntryValue()) ? null : TDoubleFloatMapDecorator.this.wrapValue(iv);
/* 217 */                 return new Map.Entry<Double, Float>() {
...
/* 239 */                       this.val = value;
/* 240 */                       return TDoubleFloatMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 264 */             TDoubleFloatMapDecorator.this._map.remove(TDoubleFloatMapDecorator.this.unwrapKey(key));
/* 265 */             modified = true;
/*     */           } 
/* 267 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 275 */           TDoubleFloatMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/* 332 */     Iterator<? extends Map.Entry<? extends Double, ? extends Float>> it = map.entrySet().iterator();
/* 334 */     for (int i = map.size(); i-- > 0; ) {
/* 335 */       Map.Entry<? extends Double, ? extends Float> e = it.next();
...
/* 390 */     in.readByte();
/* 393 */     this._map = (TDoubleFloatMap)in.readObject();
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\decorator\TDoubleFloatMapDecorator.class
