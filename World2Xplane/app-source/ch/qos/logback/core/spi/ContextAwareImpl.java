...
/* 79 */     addStatus((Status)new InfoStatus(msg, getOrigin()));
/*    */   }
/*    */   
/*    */   public void addInfo(String msg, Throwable ex) {
/* 83 */     addStatus((Status)new InfoStatus(msg, getOrigin(), ex));
/*    */   }
/*    */   
/*    */   public void addWarn(String msg) {
/* 87 */     addStatus((Status)new WarnStatus(msg, getOrigin()));
/*    */   }
/*    */   
/*    */   public void addWarn(String msg, Throwable ex) {
/* 91 */     addStatus((Status)new WarnStatus(msg, getOrigin(), ex));
/*    */   }
/*    */   
/*    */   public void addError(String msg) {
/* 95 */     addStatus((Status)new ErrorStatus(msg, getOrigin()));
/*    */   }
/*    */   
/*    */   public void addError(String msg, Throwable ex) {
/* 99 */     addStatus((Status)new ErrorStatus(msg, getOrigin(), ex));
/*    */   }
/*    */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\spi\ContextAwareImpl.class
