...
/*      */   
/*   61 */   private final TObjectLongProcedure<K> PUT_ALL_PROC = new TObjectLongProcedure<K>() {
...
/*  413 */     return new TObjectLongHashIterator<K>(this);
/*      */   }
/*      */   
...
/*  445 */     index = -index - 1;
/*  446 */     long newValue = this._values[index] = this._values[index] + adjust_amount;
...
/*  582 */       return false; 
/*      */     try {
/*  585 */       TObjectLongIterator<K> iter = iterator();
...
/*  629 */       return (Iterator<K>)new TObjectHashIterator(TObjectLongHashMap.this);
/*      */     }
/*      */     
...
/*  955 */       protected THash _hash = (THash)TObjectLongHashMap.this;
/*      */       
...
/* 1132 */     forEachEntry(new TObjectLongProcedure<K>() {
/*      */           private boolean first = true;
/*      */           
/*      */           public boolean execute(K key, long value) {
/* 1135 */             if (this.first) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TObjectLongHashMap.class
