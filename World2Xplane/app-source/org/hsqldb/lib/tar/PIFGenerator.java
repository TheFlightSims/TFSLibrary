...
public class PIFGenerator extends ByteArrayOutputStream {
  ...
  protected PIFGenerator() {
    try {
      ...
      throw new RuntimeException("Serious problem.  JVM can't encode UTF-8", unsupportedEncodingException);
    } 
  ...
  public void addRecord(String paramString, boolean paramBoolean) throws TarMalformatException, IOException {
    addRecord(paramString, Boolean.toString(paramBoolean));
  }
  
  public void addRecord(String paramString, int paramInt) throws TarMalformatException, IOException {
    addRecord(paramString, Integer.toString(paramInt));
  }
  
  public void addRecord(String paramString, long paramLong) throws TarMalformatException, IOException {
    addRecord(paramString, Long.toString(paramLong));
  }
  
  public void addRecord(String paramString1, String paramString2) throws TarMalformatException, IOException {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\lib\tar\PIFGenerator.class
