...
/* 100 */       float sx = pb.getFloatParameter(0);
/* 101 */       float sy = pb.getFloatParameter(1);
/* 102 */       float tx = pb.getFloatParameter(2);
/* 103 */       float ty = pb.getFloatParameter(3);
/* 106 */       AffineTransform transform = new AffineTransform(sx, 0.0D, 0.0D, sy, tx, ty);
/* 110 */       ROI dstROI = srcROI.transform(transform);
/* 113 */       Rectangle dstBounds = op.getBounds();
/* 116 */       if (!dstBounds.contains(dstROI.getBounds()))
/* 117 */         dstROI = dstROI.intersect((ROI)new ROIShape(dstBounds)); 
/* 121 */       return dstROI;
/*     */     } 
/* 124 */     return Image.UndefinedProperty;
/*     */   }
/*     */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\javax\media\jai\operator\ScalePropertyGenerator.class
