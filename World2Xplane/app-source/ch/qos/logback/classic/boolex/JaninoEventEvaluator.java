...
/*     */   
/*  36 */   public static final List<String> DEFAULT_PARAM_NAME_LIST = new ArrayList<String>();
/*     */   
/*  37 */   public static final List<Class> DEFAULT_PARAM_TYPE_LIST = (List)new ArrayList<Class<?>>();
/*     */   
/*     */   static {
...
/*  92 */       Matcher m = this.matcherList.get(i);
/*  93 */       fullNameList.add(m.getName());
/*     */     } 
/*  96 */     return fullNameList.<String>toArray(CoreConstants.EMPTY_STRING_ARRAY);
/*     */   }
/*     */   
/*     */   protected Class[] getParameterTypes() {
/* 100 */     List<Class<?>> fullTypeList = new ArrayList<Class<?>>();
/* 101 */     fullTypeList.addAll((Collection)DEFAULT_PARAM_TYPE_LIST);
/* 102 */     for (int i = 0; i < this.matcherList.size(); i++)
/* 103 */       fullTypeList.add(Matcher.class); 
/* 105 */     return (Class[])fullTypeList.<Class<?>[]>toArray((Class<?>[][])CoreConstants.EMPTY_CLASS_ARRAY);
/*     */   }
/*     */   
...
/* 148 */       values[i++] = this.matcherList.get(j); 
/* 151 */     return values;
/*     */   }
/*     */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\classic\boolex\JaninoEventEvaluator.class
