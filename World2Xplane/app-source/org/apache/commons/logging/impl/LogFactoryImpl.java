...
/*  190 */     this.useTCCL = true;
/*  201 */     this.attributes = new Hashtable();
/*  208 */     this.instances = new Hashtable();
/*  224 */     this.logConstructor = null;
/*  230 */     this.logConstructorSignature = new Class[] { String.class };
/*  238 */     this.logMethod = null;
/*  244 */     this.logMethodSignature = new Class[] { LogFactory.class };
/*      */     initDiagnostics();
...
/*  608 */         instance = this.logConstructor.newInstance(params);
/*      */       } 
...
/*  664 */     return AccessController.<ClassLoader>doPrivileged(new PrivilegedAction() {
/*      */           public Object run() {
...
/*  683 */     return AccessController.<String>doPrivileged(new PrivilegedAction(key, def) {
/*      */           private final String val$key;
/*      */           
/*      */           private final String val$def;
/*      */           
/*      */           public Object run() {
/*  686 */             return System.getProperty(this.val$key, this.val$def);
/*      */           }
/*      */         });
/*      */   }
/*      */   
...
/*      */     try {
/*  700 */       return AccessController.<ClassLoader>doPrivileged(new PrivilegedAction(this, cl) {
/*      */             private final ClassLoader val$cl;
/*      */             
/*      */             private final LogFactoryImpl this$0;
/*      */             
/*      */             public Object run() {
/*  703 */               return this.val$cl.getParent();
/*      */             }
/*      */           });
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\logging\impl\LogFactoryImpl.class
