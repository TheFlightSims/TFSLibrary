...
/* 2982 */       return Iterables.<Map.Entry<K, V>>removeFirstMatching(this.unfiltered.entrySet(), this.entryPredicate);
/*      */     }
/*      */     
/*      */     public Map.Entry<K, V> pollLastEntry() {
/* 2987 */       return Iterables.<Map.Entry<K, V>>removeFirstMatching(this.unfiltered.descendingMap().entrySet(), this.entryPredicate);
/*      */     }
/*      */     
/*      */     public NavigableMap<K, V> descendingMap() {
...
/* 3053 */       return (BiMap<K, V>)this.unfiltered;
/*      */     }
/*      */     
...
/*      */     
/*      */     Set<K> createKeySet() {
/* 3326 */       return new Maps.KeySet<K, V>(this);
/*      */     }
/*      */     
/*      */     public Collection<V> values() {
...
/*      */     
/*      */     Collection<V> createValues() {
/* 3337 */       return new Maps.Values<K, V>(this);
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     KeySet(Map<K, V> map) {
/* 3480 */       this.map = (Map<K, V>)Preconditions.checkNotNull(map);
/*      */     }
/*      */     
/*      */     Map<K, V> map() {
...
/* 3575 */       return (NavigableMap<K, V>)this.map;
/*      */     }
/*      */     
/*      */     public K lower(K e) {
...
/*      */     
/*      */     Values(Map<K, V> map) {
/* 3657 */       this.map = (Map<K, V>)Preconditions.checkNotNull(map);
/*      */     }
/*      */     
/*      */     final Map<K, V> map() {
...
/* 3817 */       return Ordering.<T>from(forward).reverse();
/*      */     }
/*      */     
/*      */     public K firstKey() {
...
/* 3929 */       return (result == null) ? (this.navigableKeySet = new Maps.NavigableKeySet<K, V>(this)) : result;
/*      */     }
/*      */     
/*      */     public NavigableSet<K> descendingKeySet() {
...
/*      */     
/*      */     public Collection<V> values() {
/* 3971 */       return new Maps.Values<K, V>(this);
/*      */     }
/*      */     
/*      */     public String toString() {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\google\common\collect\Maps.class
