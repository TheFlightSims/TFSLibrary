...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TByteIntHashMap) {
/*  134 */       TByteIntHashMap hashmap = (TByteIntHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Byte, ? extends Integer> entry : map.entrySet())
/*  234 */       put(((Byte)entry.getKey()).byteValue(), ((Integer)entry.getValue()).intValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TByteIntMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TByteIntIterator iter = map.iterator();
...
/*  393 */     return new TByteIntHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TByteIntHashMap.TByteIntKeyHashIterator((TPrimitiveHash)TByteIntHashMap.this);
/*      */     }
/*      */     
/*      */     public byte getNoEntryValue() {
/*  521 */       return TByteIntHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TByteIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TByteIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(byte entry) {
/*  539 */       return TByteIntHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public byte[] toArray() {
/*  545 */       return TByteIntHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public byte[] toArray(byte[] dest) {
/*  551 */       return TByteIntHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TByteIntHashMap.this.no_entry_value != TByteIntHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TByteIntHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TByteIntHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TByteIntHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       byte[] set = TByteIntHashMap.this._set;
/*  677 */       byte[] states = TByteIntHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TByteIntHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TByteIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TByteProcedure procedure) {
/*  742 */       return TByteIntHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TByteIntHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TByteIntHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TByteIntHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TByteIntHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TByteIntHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TByteIntHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TByteIntHashMap.this.forEachKey(new TByteProcedure() {
...
/*  807 */       return new TByteIntHashMap.TByteIntValueHashIterator((TPrimitiveHash)TByteIntHashMap.this);
/*      */     }
/*      */     
/*      */     public int getNoEntryValue() {
/*  813 */       return TByteIntHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TByteIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TByteIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(int entry) {
/*  831 */       return TByteIntHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public int[] toArray() {
/*  837 */       return TByteIntHashMap.this.values();
/*      */     }
/*      */     
/*      */     public int[] toArray(int[] dest) {
/*  843 */       return TByteIntHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       int[] values = TByteIntHashMap.this._values;
/*  856 */       byte[] set = TByteIntHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0 && set[i] != 2 && entry == values[i]) {
/*  860 */           TByteIntHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TByteIntHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TByteIntHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TByteIntHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       int[] values = TByteIntHashMap.this._values;
/*  962 */       byte[] states = TByteIntHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TByteIntHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TByteIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TIntProcedure procedure) {
/* 1027 */       return TByteIntHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TByteIntHashMap.this.forEachValue(new TIntProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TByteIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TByteIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TByteIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TByteIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public byte key() {
/* 1148 */       return TByteIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public int value() {
/* 1153 */       return TByteIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public int setValue(int val) {
/* 1158 */       int old = value();
/* 1159 */       TByteIntHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TByteIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TByteIntMap))
/* 1185 */       return false; 
/* 1187 */     TByteIntMap that = (TByteIntMap)other;
...
/* 1230 */     forEachEntry(new TByteIntProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TByteIntHashMap.class
