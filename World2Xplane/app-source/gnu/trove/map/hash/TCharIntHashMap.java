...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TCharIntHashMap) {
/*  134 */       TCharIntHashMap hashmap = (TCharIntHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Character, ? extends Integer> entry : map.entrySet())
/*  234 */       put(((Character)entry.getKey()).charValue(), ((Integer)entry.getValue()).intValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TCharIntMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TCharIntIterator iter = map.iterator();
...
/*  393 */     return new TCharIntHashIterator(this);
/*      */   }
/*      */   
...
/*  488 */     int newValue, index = insertKey(key);
/*  491 */     if (index < 0) {
/*  492 */       index = -index - 1;
...
/*  515 */       return new TCharIntHashMap.TCharIntKeyHashIterator((TPrimitiveHash)TCharIntHashMap.this);
/*      */     }
/*      */     
/*      */     public char getNoEntryValue() {
/*  521 */       return TCharIntHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TCharIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TCharIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(char entry) {
/*  539 */       return TCharIntHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public char[] toArray() {
/*  545 */       return TCharIntHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public char[] toArray(char[] dest) {
/*  551 */       return TCharIntHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TCharIntHashMap.this.no_entry_value != TCharIntHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TCharIntHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TCharIntHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TCharIntHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       char[] set = TCharIntHashMap.this._set;
/*  677 */       byte[] states = TCharIntHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TCharIntHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TCharIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TCharProcedure procedure) {
/*  742 */       return TCharIntHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TCharIntHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TCharIntHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TCharIntHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TCharIntHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TCharIntHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TCharIntHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TCharIntHashMap.this.forEachKey(new TCharProcedure() {
...
/*  807 */       return new TCharIntHashMap.TCharIntValueHashIterator((TPrimitiveHash)TCharIntHashMap.this);
/*      */     }
/*      */     
/*      */     public int getNoEntryValue() {
/*  813 */       return TCharIntHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TCharIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TCharIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(int entry) {
/*  831 */       return TCharIntHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public int[] toArray() {
/*  837 */       return TCharIntHashMap.this.values();
/*      */     }
/*      */     
/*      */     public int[] toArray(int[] dest) {
/*  843 */       return TCharIntHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       int[] values = TCharIntHashMap.this._values;
/*  856 */       char[] set = TCharIntHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != '\000' && set[i] != '\002' && entry == values[i]) {
/*  860 */           TCharIntHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TCharIntHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TCharIntHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TCharIntHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       int[] values = TCharIntHashMap.this._values;
/*  962 */       byte[] states = TCharIntHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TCharIntHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TCharIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TIntProcedure procedure) {
/* 1027 */       return TCharIntHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TCharIntHashMap.this.forEachValue(new TIntProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TCharIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TCharIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TCharIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TCharIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public char key() {
/* 1148 */       return TCharIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public int value() {
/* 1153 */       return TCharIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public int setValue(int val) {
/* 1158 */       int old = value();
/* 1159 */       TCharIntHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TCharIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TCharIntMap))
/* 1185 */       return false; 
/* 1187 */     TCharIntMap that = (TCharIntMap)other;
...
/* 1230 */     forEachEntry(new TCharIntProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TCharIntHashMap.class
