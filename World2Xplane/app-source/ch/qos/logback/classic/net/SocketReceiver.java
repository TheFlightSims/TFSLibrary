...
/*     */     try {
/* 144 */       return getContext().getExecutorService().submit((Callable<Socket>)connector);
...
/*     */     try {
/* 152 */       Socket s = this.connectorTask.get();
...
/* 192 */     } else if (ex instanceof java.net.ConnectException) {
...
/* 202 */     return (SocketConnector)new DefaultSocketConnector(address, port, initialDelay, retryDelay);
/*     */   }
/*     */   
