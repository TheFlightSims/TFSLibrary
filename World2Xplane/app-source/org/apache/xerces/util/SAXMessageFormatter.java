...
public class SAXMessageFormatter {
  public static String formatMessage(Locale paramLocale, String paramString, Object[] paramArrayOfObject) throws MissingResourceException {
    ...
    if (paramLocale != null) {
      resourceBundle = ResourceBundle.getBundle("org.apache.xerces.impl.msg.SAXMessages", paramLocale);
    } else {
      resourceBundle = ResourceBundle.getBundle("org.apache.xerces.impl.msg.SAXMessages");
    } 
    try {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerce\\util\SAXMessageFormatter.class
