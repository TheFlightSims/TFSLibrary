...
/* 79 */     if (this == o)
/* 79 */       return true; 
/* 80 */     if (!(o instanceof LoggerContextVO))
/* 80 */       return false; 
/* 82 */     LoggerContextVO that = (LoggerContextVO)o;
/* 84 */     if (this.birthTime != that.birthTime)
/* 84 */       return false; 
/* 85 */     if ((this.name != null) ? !this.name.equals(that.name) : (that.name != null))
/* 85 */       return false; 
...
/* 95 */     result = 31 * result + (int)(this.birthTime ^ this.birthTime >>> 32L);
/* 97 */     return result;
/*    */   }
/*    */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\classic\spi\LoggerContextVO.class
