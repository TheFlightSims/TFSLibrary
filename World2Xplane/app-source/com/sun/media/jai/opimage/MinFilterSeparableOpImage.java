...
/*  54 */     super(source, extender, config, layout, MinFilterDescriptor.MIN_MASK_SQUARE, maskSize);
/*     */   }
/*     */   
...
/*  79 */     int[] minValues = new int[filterSize];
...
/* 119 */           int minval = Integer.MAX_VALUE;
/* 120 */           for (int v = 0; v < wp; v++) {
/* 121 */             int val = srcData[imageOffset] & 0xFF;
/* 122 */             imageOffset += srcPixelStride;
/* 123 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 125 */           tmpBuffer[revolver + i] = minval;
/* 127 */           minval = Integer.MAX_VALUE;
/*     */           int b;
/* 128 */           for (b = i; b < tmpBufferSize; b += dwidth) {
/* 129 */             int val = tmpBuffer[b];
/* 130 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 133 */           dstData[dstPixelOffset] = (byte)minval;
...
/* 166 */     int[] minValues = new int[filterSize];
...
/* 184 */           int minval = Integer.MAX_VALUE;
/* 185 */           for (int v = 0; v < wp; v++) {
/* 186 */             int val = srcData[imageOffset];
/* 187 */             imageOffset += srcPixelStride;
/* 188 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 190 */           tmpBuffer[revolver + i] = minval;
...
/* 206 */           int minval = Integer.MAX_VALUE;
/* 207 */           for (int v = 0; v < wp; v++) {
/* 208 */             int val = srcData[imageOffset];
/* 209 */             imageOffset += srcPixelStride;
/* 210 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 212 */           tmpBuffer[revolver + i] = minval;
/* 214 */           minval = Integer.MAX_VALUE;
/*     */           int b;
/* 215 */           for (b = i; b < tmpBufferSize; b += dwidth) {
/* 216 */             int val = tmpBuffer[b];
/* 217 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 220 */           dstData[dstPixelOffset] = (short)minval;
...
/* 253 */     int[] minValues = new int[filterSize];
...
/* 271 */           int minval = Integer.MAX_VALUE;
/* 272 */           for (int v = 0; v < wp; v++) {
/* 273 */             int val = srcData[imageOffset] & 0xFFF;
/* 274 */             imageOffset += srcPixelStride;
/* 275 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 277 */           tmpBuffer[revolver + i] = minval;
...
/* 293 */           int minval = Integer.MAX_VALUE;
...
/*     */           } 
/* 299 */           tmpBuffer[revolver + i] = minval;
/* 301 */           minval = Integer.MAX_VALUE;
/*     */           int b;
/* 302 */           for (b = i; b < tmpBufferSize; b += dwidth) {
/* 303 */             int val = tmpBuffer[b];
/* 304 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 307 */           dstData[dstPixelOffset] = (short)minval;
...
/* 338 */     int[] minValues = new int[filterSize];
...
/* 378 */           int minval = Integer.MAX_VALUE;
/* 379 */           for (int v = 0; v < wp; v++) {
/* 380 */             int val = srcData[imageOffset];
/* 381 */             imageOffset += srcPixelStride;
/* 382 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 384 */           tmpBuffer[revolver + i] = minval;
/* 386 */           minval = Integer.MAX_VALUE;
/*     */           int b;
/* 387 */           for (b = i; b < tmpBufferSize; b += dwidth) {
/* 388 */             int val = tmpBuffer[b];
/* 389 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 392 */           dstData[dstPixelOffset] = minval;
...
/* 424 */     float[] minValues = new float[filterSize];
...
/* 442 */           float minval = Float.MAX_VALUE;
/* 443 */           for (int v = 0; v < wp; v++) {
/* 444 */             float val = srcData[imageOffset];
/* 445 */             imageOffset += srcPixelStride;
/* 446 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 448 */           tmpBuffer[revolver + i] = minval;
...
/* 464 */           float minval = Float.MAX_VALUE;
/* 465 */           for (int v = 0; v < wp; v++) {
/* 466 */             float val = srcData[imageOffset];
/* 467 */             imageOffset += srcPixelStride;
/* 468 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 470 */           tmpBuffer[revolver + i] = minval;
/* 472 */           minval = Float.MAX_VALUE;
/*     */           int b;
/* 473 */           for (b = i; b < tmpBufferSize; b += dwidth) {
/* 474 */             float val = tmpBuffer[b];
/* 475 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 478 */           dstData[dstPixelOffset] = minval;
...
/* 509 */     double[] minValues = new double[filterSize];
...
/* 527 */           double minval = Double.MAX_VALUE;
/* 528 */           for (int v = 0; v < wp; v++) {
/* 529 */             double val = srcData[imageOffset];
/* 530 */             imageOffset += srcPixelStride;
/* 531 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 533 */           tmpBuffer[revolver + i] = minval;
...
/* 549 */           double minval = Double.MAX_VALUE;
/* 550 */           for (int v = 0; v < wp; v++) {
/* 551 */             double val = srcData[imageOffset];
/* 552 */             imageOffset += srcPixelStride;
/* 553 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 555 */           tmpBuffer[revolver + i] = minval;
/* 557 */           minval = Double.MAX_VALUE;
/*     */           int b;
/* 558 */           for (b = i; b < tmpBufferSize; b += dwidth) {
/* 559 */             double val = tmpBuffer[b];
/* 560 */             minval = (val < minval) ? val : minval;
/*     */           } 
/* 563 */           dstData[dstPixelOffset] = minval;
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\sun\media\jai\opimage\MinFilterSeparableOpImage.class
