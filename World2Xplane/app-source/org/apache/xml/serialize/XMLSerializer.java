...
public class XMLSerializer extends BaseMarkupSerializer {
    ...
    try {
      ...
      if (this._prefixes != null) {
        ...
        while (enumeration.hasMoreElements()) {
          ...
          String str1 = (String)this._prefixes.get(str2);
          if (str1.length() == 0) {
      ...
      elementState = enterElementState(paramString1, paramString2, paramString3, bool);
  ...
  public void endElementIO(String paramString1, String paramString2, String paramString3) throws IOException {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xml\serialize\XMLSerializer.class
