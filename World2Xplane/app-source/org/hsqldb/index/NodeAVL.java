...
public class NodeAVL implements CachedObject {
  ...
  boolean isFromLeft(PersistentStore paramPersistentStore) {
    return (this.nParent == null) ? true : ((this == this.nParent.nLeft));
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\index\NodeAVL.class
