...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TLongDoubleHashMap) {
/*  134 */       TLongDoubleHashMap hashmap = (TLongDoubleHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Long, ? extends Double> entry : map.entrySet())
/*  234 */       put(((Long)entry.getKey()).longValue(), ((Double)entry.getValue()).doubleValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TLongDoubleMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TLongDoubleIterator iter = map.iterator();
...
/*  393 */     return new TLongDoubleHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TLongDoubleHashMap.TLongDoubleKeyHashIterator((TPrimitiveHash)TLongDoubleHashMap.this);
/*      */     }
/*      */     
/*      */     public long getNoEntryValue() {
/*  521 */       return TLongDoubleHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TLongDoubleHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TLongDoubleHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(long entry) {
/*  539 */       return TLongDoubleHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public long[] toArray() {
/*  545 */       return TLongDoubleHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public long[] toArray(long[] dest) {
/*  551 */       return TLongDoubleHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TLongDoubleHashMap.this.no_entry_value != TLongDoubleHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TLongDoubleHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TLongDoubleHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TLongDoubleHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       long[] set = TLongDoubleHashMap.this._set;
/*  677 */       byte[] states = TLongDoubleHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TLongDoubleHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TLongDoubleHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TLongProcedure procedure) {
/*  742 */       return TLongDoubleHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TLongDoubleHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TLongDoubleHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TLongDoubleHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TLongDoubleHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TLongDoubleHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TLongDoubleHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TLongDoubleHashMap.this.forEachKey(new TLongProcedure() {
...
/*  807 */       return new TLongDoubleHashMap.TLongDoubleValueHashIterator((TPrimitiveHash)TLongDoubleHashMap.this);
/*      */     }
/*      */     
/*      */     public double getNoEntryValue() {
/*  813 */       return TLongDoubleHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TLongDoubleHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TLongDoubleHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(double entry) {
/*  831 */       return TLongDoubleHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public double[] toArray() {
/*  837 */       return TLongDoubleHashMap.this.values();
/*      */     }
/*      */     
/*      */     public double[] toArray(double[] dest) {
/*  843 */       return TLongDoubleHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       double[] values = TLongDoubleHashMap.this._values;
/*  856 */       long[] set = TLongDoubleHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0L && set[i] != 2L && entry == values[i]) {
/*  860 */           TLongDoubleHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TLongDoubleHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TLongDoubleHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TLongDoubleHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       double[] values = TLongDoubleHashMap.this._values;
/*  962 */       byte[] states = TLongDoubleHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TLongDoubleHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TLongDoubleHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TDoubleProcedure procedure) {
/* 1027 */       return TLongDoubleHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TLongDoubleHashMap.this.forEachValue(new TDoubleProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TLongDoubleHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TLongDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TLongDoubleHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TLongDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public long key() {
/* 1148 */       return TLongDoubleHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public double value() {
/* 1153 */       return TLongDoubleHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public double setValue(double val) {
/* 1158 */       double old = value();
/* 1159 */       TLongDoubleHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TLongDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TLongDoubleMap))
/* 1185 */       return false; 
/* 1187 */     TLongDoubleMap that = (TLongDoubleMap)other;
...
/* 1230 */     forEachEntry(new TLongDoubleProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TLongDoubleHashMap.class
