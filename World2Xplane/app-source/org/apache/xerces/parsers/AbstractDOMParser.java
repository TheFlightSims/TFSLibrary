...
public class AbstractDOMParser extends AbstractXMLDocumentParser {
  ...
  protected void setDocumentClassName(String paramString) {
    ...
    if (!paramString.equals("org.apache.xerces.dom.DocumentImpl") && !paramString.equals("org.apache.xerces.dom.PSVIDocumentImpl"))
      try {
        Class clazz = ObjectFactory.findProviderClass(paramString, ObjectFactory.findClassLoader(), true);
  ...
  public void startDocument(XMLLocator paramXMLLocator, String paramString, NamespaceContext paramNamespaceContext, Augmentations paramAugmentations) throws XNIException {
    ...
    if (!this.fDeferNodeExpansion) {
      if (this.fDocumentClassName.equals("org.apache.xerces.dom.DocumentImpl")) {
        this.fDocument = (Document)new DocumentImpl();
        ...
        this.fDocument = (Document)new PSVIDocumentImpl();
        this.fDocumentImpl = (CoreDocumentImpl)this.fDocument;
        ...
        try {
          ...
          this.fDocument = clazz.newInstance();
          Class clazz1 = ObjectFactory.findProviderClass("org.apache.xerces.dom.CoreDocumentImpl", classLoader, true);
          if (clazz1.isAssignableFrom(clazz)) {
            this.fDocumentImpl = (CoreDocumentImpl)this.fDocument;
            Class clazz2 = ObjectFactory.findProviderClass("org.apache.xerces.dom.PSVIDocumentImpl", classLoader, true);
      ...
      this.fDocument = (Document)this.fDeferredDocumentImpl;
  ...
  public void startElement(QName paramQName, XMLAttributes paramXMLAttributes, Augmentations paramAugmentations) throws XNIException {
    if (!this.fDeferNodeExpansion) {
      ...
      for (byte b = 0; b < i; b++) {
        ...
        attr.setValue(str);
        boolean bool1 = paramXMLAttributes.isSpecified(b);
        if (!bool1 && (bool || (this.fAttrQName.uri != null && this.fAttrQName.prefix == null))) {
        ...
        if (this.fDocumentImpl != null) {
          ...
          if (attributePSVI != null && this.fNamespaceAware) {
            ...
            String str1;
            boolean bool3 = Boolean.TRUE.equals(paramXMLAttributes.getAugmentations(b).getItem("ATTRIBUTE_DECLARED"));
            if (bool3) {
      ...
      if (this.fDOMFilter != null && !this.fInEntityRef)
        if (this.fRoot.rawname == null) {
          ...
          short s = this.fDOMFilter.startElement(element);
          switch (s) {
            case 4:
              throw ABORT;
            case 2:
  ...
  public void endGeneralEntity(String paramString, Augmentations paramAugmentations) throws XNIException {
    if (!this.fDeferNodeExpansion) {
      ...
      if (this.fDeferredEntityDecl != -1 && this.fDeferredDocumentImpl.getLastChild(this.fDeferredEntityDecl, false) == -1) {
        int i = -1;
        for (int j = this.fDeferredDocumentImpl.getLastChild(this.fCurrentNodeIndex, false); j != -1; j = this.fDeferredDocumentImpl.getRealPrevSibling(j, false)) {
  ...
  public void internalEntityDecl(String paramString, XMLString paramXMLString1, XMLString paramXMLString2, Augmentations paramAugmentations) throws XNIException {
    if (this.fInternalSubset != null && !this.fInDTDExternalSubset) {
      ...
      boolean bool = (str.indexOf('\'') == -1) ? true : false;
    ...
    if (this.fDocumentTypeIndex != -1) {
      ...
      if (!bool) {
        int j = this.fDeferredDocumentImpl.createDeferredEntity(paramString, null, null, null, this.fBaseURIStack.peek());
  ...
  public void attributeDecl(String paramString1, String paramString2, String paramString3, String[] paramArrayOfString, String paramString4, XMLString paramXMLString1, XMLString paramXMLString2, Augmentations paramAugmentations) throws XNIException {
    if (this.fInternalSubset != null && !this.fInDTDExternalSubset) {
      ...
      if (paramXMLString1 != null) {
        this.fInternalSubset.append(" '");
        for (byte b = 0; b < paramXMLString1.length; b++) {
          char c = paramXMLString1.ch[paramXMLString1.offset + b];
          if (c == '\'') {
            this.fInternalSubset.append("&apos;");
          } else {
    ...
    if (this.fDeferredDocumentImpl != null) {
      ...
      if (elementDefinitionImpl == null) {
        ...
        ((DocumentTypeImpl)this.fDocumentType).getElements().setNamedItem((Node)elementDefinitionImpl);
      } 
      ...
      if (bool) {
        elementDefinitionImpl.getAttributes().setNamedItemNS((Node)attrImpl);
      } else {
        elementDefinitionImpl.getAttributes().setNamedItem((Node)attrImpl);
      } 
    } 
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\parsers\AbstractDOMParser.class
