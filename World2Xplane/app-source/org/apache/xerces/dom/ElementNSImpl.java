...
public class ElementNSImpl extends ElementImpl {
  ...
  public String getTypeName() {
    return (this.type != null) ? ((this.type instanceof org.apache.xerces.xs.XSSimpleTypeDefinition) ? ((XSSimpleTypeDecl)this.type).getTypeName() : ((XSComplexTypeDecl)this.type).getTypeName()) : null;
  }
  ...
  public boolean isDerivedFrom(String paramString1, String paramString2, int paramInt) {
    if (needsSyncData())
      synchronizeData(); 
    return (this.type != null) ? ((this.type instanceof org.apache.xerces.xs.XSSimpleTypeDefinition) ? ((XSSimpleTypeDecl)this.type).isDOMDerivedFrom(paramString1, paramString2, paramInt) : ((XSComplexTypeDecl)this.type).isDOMDerivedFrom(paramString1, paramString2, paramInt)) : false;
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\ElementNSImpl.class
