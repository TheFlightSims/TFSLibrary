...
public class TextImpl extends CharacterDataImpl implements CharacterData, Text {
  ...
  private boolean getWholeTextForward(Node paramNode1, StringBuffer paramStringBuffer, Node paramNode2) {
    boolean bool = false;
    if (paramNode2 != null)
      bool = (paramNode2.getNodeType() == 5) ? true : false; 
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\TextImpl.class
