...
public class Quat4f extends Tuple4f implements Serializable {
  ...
  public final void mulInverse(Quat4f paramQuat4f1, Quat4f paramQuat4f2) {
    Quat4f quat4f = new Quat4f(paramQuat4f2);
    quat4f.inverse();
    mul(paramQuat4f1, quat4f);
  }
  
  public final void mulInverse(Quat4f paramQuat4f) {
    Quat4f quat4f = new Quat4f(paramQuat4f);
    quat4f.inverse();
    mul(quat4f);
  }
  ...
  public final void set(AxisAngle4f paramAxisAngle4f) {
    ...
    if (f < 1.0E-6D) {
      ...
      this.x = paramAxisAngle4f.x * f * f1;
      this.y = paramAxisAngle4f.y * f * f1;
      this.z = paramAxisAngle4f.z * f * f1;
    } 
  }
  
  public final void set(AxisAngle4d paramAxisAngle4d) {
    float f = (float)(1.0D / Math.sqrt(paramAxisAngle4d.x * paramAxisAngle4d.x + paramAxisAngle4d.y * paramAxisAngle4d.y + paramAxisAngle4d.z * paramAxisAngle4d.z));
    if (f < 1.0E-6D) {
      this.w = 0.0F;
      this.x = 0.0F;
      this.y = 0.0F;
      ...
      this.x = (float)paramAxisAngle4d.x * f * f1;
      this.y = (float)paramAxisAngle4d.y * f * f1;
      this.z = (float)paramAxisAngle4d.z * f * f1;
    } 
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\javax\vecmath\Quat4f.class
