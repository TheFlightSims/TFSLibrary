...
public class ClosableByteArrayOutputStream extends OutputStream {
  ...
  public ClosableByteArrayOutputStream(int paramInt) throws IllegalArgumentException {
    if (paramInt < 0)
  ...
  public synchronized String toString(String paramString) throws IOException, UnsupportedEncodingException {
    checkFreed();
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\lib\ClosableByteArrayOutputStream.class
