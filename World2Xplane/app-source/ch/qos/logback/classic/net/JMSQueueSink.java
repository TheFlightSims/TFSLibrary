...
/* 105 */       MessageConsumer queueConsumer = queueSession.createConsumer((Destination)queue);
...
/* 130 */       this.logger.error("Exception thrown while processing incoming message.", (Throwable)jmse);
/*     */     } 
/*     */   }
/*     */   
