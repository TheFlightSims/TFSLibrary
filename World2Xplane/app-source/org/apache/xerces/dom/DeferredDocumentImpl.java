    ...
    if (k == 3) {
      ...
      if (m != -1 && getNodeType(m, false) == 3) {
        ...
        for (int i1 = n - 1; i1 >= 0; i1--)
          this.fBufferStr.append(this.fStrChunks.elementAt(i1)); 
      ...
      if (m != -1) {
        ...
        for (int n = this.fStrChunks.size() - 1; n >= 0; n--)
          this.fBufferStr.append(this.fStrChunks.elementAt(n)); 
        str = this.fBufferStr.toString();
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\DeferredDocumentImpl.class
