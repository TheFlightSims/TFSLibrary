...
/* 103 */     return new ZipShort(14 + (getLinkedFile().getBytes()).length);
/*     */   }
/*     */   
...
/* 132 */     System.arraycopy(ZipLong.getBytes(linkArray.length), 0, data, 2, 4);
/* 135 */     System.arraycopy(ZipShort.getBytes(getUserId()), 0, data, 6, 2);
/* 137 */     System.arraycopy(ZipShort.getBytes(getGroupId()), 0, data, 8, 2);
...
/* 272 */       throw new ZipException("bad CRC checksum " + Long.toHexString(givenChecksum) + " instead of " + Long.toHexString(realChecksum)); 
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\compress\archivers\zip\AsiExtraField.class
