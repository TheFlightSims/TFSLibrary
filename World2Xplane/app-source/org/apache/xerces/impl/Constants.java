...
public final class Constants {
  ...
  private static final String[] fgXercesFeatures = new String[] { 
      ...
      "dom/include-ignorable-whitespace", "validation/default-attribute-values", "validation/validate-content-models", "validation/validate-datatypes", "validation/balance-syntax-trees", "scanner/notify-char-refs", "scanner/notify-builtin-refs", "disallow-doctype-decl", "standard-uri-conformant", "generate-synthetic-annotations", 
      "validate-annotations", "honour-all-schemaLocations", "xinclude", "xinclude/fixup-base-uris", "xinclude/fixup-language", "validation/schema/ignore-xsi-type-until-elemdecl", "validation/id-idref-checking", "validation/identity-constraint-checking", "validation/unparsed-entity-checking" };
  ...
  private static final String[] fgXercesProperties = new String[] { 
      ...
      "internal/dtd-scanner", "internal/validator", "schema/external-schemaLocation", "schema/external-noNamespaceSchemaLocation", "internal/validation-manager", "input-buffer-size", "security-manager", "validation/schema/root-type-definition" };
  ...
  public static Enumeration getSAXFeatures() {
    return (fgSAXFeatures.length > 0) ? new ArrayEnumeration((Object[])fgSAXFeatures) : fgEmptyEnumeration;
  }
  
  public static Enumeration getSAXProperties() {
    return (fgSAXProperties.length > 0) ? new ArrayEnumeration((Object[])fgSAXProperties) : fgEmptyEnumeration;
  }
  
  public static Enumeration getXercesFeatures() {
    return (fgXercesFeatures.length > 0) ? new ArrayEnumeration((Object[])fgXercesFeatures) : fgEmptyEnumeration;
  }
  
  public static Enumeration getXercesProperties() {
    return (fgXercesProperties.length > 0) ? new ArrayEnumeration((Object[])fgXercesProperties) : fgEmptyEnumeration;
  }
  
  public static void main(String[] paramArrayOfString) {
    print("SAX features:", "http://xml.org/sax/features/", (Object[])fgSAXFeatures);
    print("SAX properties:", "http://xml.org/sax/properties/", (Object[])fgSAXProperties);
    print("Xerces features:", "http://apache.org/xml/features/", (Object[])fgXercesFeatures);
    print("Xerces properties:", "http://apache.org/xml/properties/", (Object[])fgXercesProperties);
  }
  ...
  private static void print(String paramString1, String paramString2, Object[] paramArrayOfObject) {
    ...
    if (paramArrayOfObject.length > 0) {
      ...
      for (byte b = 0; b < paramArrayOfObject.length; b++) {
        ...
        System.out.println(paramArrayOfObject[b]);
      } 
    } else {
  ...
  static class ArrayEnumeration implements Enumeration {
    ...
    public ArrayEnumeration(Object[] param1ArrayOfObject) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\Constants.class
