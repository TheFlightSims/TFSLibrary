...
/* 187 */     return new AbstractSet<Map.Entry<Double, Integer>>() {
/*     */         public int size() {
/* 189 */           return TDoubleIntMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 193 */           return TDoubleIntMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 200 */             return (TDoubleIntMapDecorator.this.containsKey(k) && TDoubleIntMapDecorator.this.get(k).equals(v));
/*     */           } 
/* 203 */           return false;
/*     */         }
/*     */         
/*     */         public Iterator<Map.Entry<Double, Integer>> iterator() {
/* 208 */           return new Iterator<Map.Entry<Double, Integer>>() {
/* 209 */               private final TDoubleIntIterator it = TDoubleIntMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Double, Integer> next() {
/* 212 */                 this.it.advance();
/* 213 */                 double ik = this.it.key();
/* 214 */                 final Double key = (ik == TDoubleIntMapDecorator.this._map.getNoEntryKey()) ? null : TDoubleIntMapDecorator.this.wrapKey(ik);
/* 215 */                 int iv = this.it.value();
/* 216 */                 final Integer v = (iv == TDoubleIntMapDecorator.this._map.getNoEntryValue()) ? null : TDoubleIntMapDecorator.this.wrapValue(iv);
/* 217 */                 return new Map.Entry<Double, Integer>() {
...
/* 239 */                       this.val = value;
/* 240 */                       return TDoubleIntMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 264 */             TDoubleIntMapDecorator.this._map.remove(TDoubleIntMapDecorator.this.unwrapKey(key));
/* 265 */             modified = true;
/*     */           } 
/* 267 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 275 */           TDoubleIntMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/* 332 */     Iterator<? extends Map.Entry<? extends Double, ? extends Integer>> it = map.entrySet().iterator();
/* 334 */     for (int i = map.size(); i-- > 0; ) {
/* 335 */       Map.Entry<? extends Double, ? extends Integer> e = it.next();
...
/* 390 */     in.readByte();
/* 393 */     this._map = (TDoubleIntMap)in.readObject();
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\decorator\TDoubleIntMapDecorator.class
