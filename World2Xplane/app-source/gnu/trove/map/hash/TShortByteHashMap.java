...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TShortByteHashMap) {
/*  134 */       TShortByteHashMap hashmap = (TShortByteHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Short, ? extends Byte> entry : map.entrySet())
/*  234 */       put(((Short)entry.getKey()).shortValue(), ((Byte)entry.getValue()).byteValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TShortByteMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TShortByteIterator iter = map.iterator();
...
/*  393 */     return new TShortByteHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TShortByteHashMap.TShortByteKeyHashIterator((TPrimitiveHash)TShortByteHashMap.this);
/*      */     }
/*      */     
/*      */     public short getNoEntryValue() {
/*  521 */       return TShortByteHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TShortByteHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TShortByteHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(short entry) {
/*  539 */       return TShortByteHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public short[] toArray() {
/*  545 */       return TShortByteHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public short[] toArray(short[] dest) {
/*  551 */       return TShortByteHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TShortByteHashMap.this.no_entry_value != TShortByteHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TShortByteHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TShortByteHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TShortByteHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       short[] set = TShortByteHashMap.this._set;
/*  677 */       byte[] states = TShortByteHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TShortByteHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TShortByteHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TShortProcedure procedure) {
/*  742 */       return TShortByteHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TShortByteHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TShortByteHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TShortByteHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TShortByteHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TShortByteHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TShortByteHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TShortByteHashMap.this.forEachKey(new TShortProcedure() {
...
/*  807 */       return new TShortByteHashMap.TShortByteValueHashIterator((TPrimitiveHash)TShortByteHashMap.this);
/*      */     }
/*      */     
/*      */     public byte getNoEntryValue() {
/*  813 */       return TShortByteHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TShortByteHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TShortByteHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(byte entry) {
/*  831 */       return TShortByteHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public byte[] toArray() {
/*  837 */       return TShortByteHashMap.this.values();
/*      */     }
/*      */     
/*      */     public byte[] toArray(byte[] dest) {
/*  843 */       return TShortByteHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       byte[] values = TShortByteHashMap.this._values;
/*  856 */       short[] set = TShortByteHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0 && set[i] != 2 && entry == values[i]) {
/*  860 */           TShortByteHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TShortByteHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TShortByteHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TShortByteHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       byte[] values = TShortByteHashMap.this._values;
/*  962 */       byte[] states = TShortByteHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TShortByteHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TShortByteHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TByteProcedure procedure) {
/* 1027 */       return TShortByteHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TShortByteHashMap.this.forEachValue(new TByteProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TShortByteHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TShortByteHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TShortByteHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TShortByteHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public short key() {
/* 1148 */       return TShortByteHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public byte value() {
/* 1153 */       return TShortByteHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte val) {
/* 1158 */       byte old = value();
/* 1159 */       TShortByteHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TShortByteHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TShortByteMap))
/* 1185 */       return false; 
/* 1187 */     TShortByteMap that = (TShortByteMap)other;
...
/* 1230 */     forEachEntry(new TShortByteProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TShortByteHashMap.class
