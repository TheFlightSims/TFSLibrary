...
/* 136 */     if (length < 1) {
/* 137 */       message.append(getName() + " " + JaiI18N.getString("SubtractConstDescriptor2"));
/* 139 */       return false;
/*     */     } 
/* 142 */     return true;
/*     */   }
...
/* 168 */     ParameterBlockJAI pb = new ParameterBlockJAI("SubtractConst", "rendered");
/* 172 */     pb.setSource("source0", source0);
/* 174 */     pb.setParameter("constants", constants);
/* 176 */     return JAI.create("SubtractConst", (ParameterBlock)pb, hints);
/*     */   }
/*     */   
/*     */   public static RenderableOp createRenderable(RenderableImage source0, double[] constants, RenderingHints hints) {
/* 201 */     ParameterBlockJAI pb = new ParameterBlockJAI("SubtractConst", "renderable");
/* 205 */     pb.setSource("source0", source0);
/* 207 */     pb.setParameter("constants", constants);
/* 209 */     return JAI.createRenderable("SubtractConst", (ParameterBlock)pb, hints);
/*     */   }
/*     */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\javax\media\jai\operator\SubtractConstDescriptor.class
