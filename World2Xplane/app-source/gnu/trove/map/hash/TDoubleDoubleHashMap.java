...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TDoubleDoubleHashMap) {
/*  134 */       TDoubleDoubleHashMap hashmap = (TDoubleDoubleHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Double, ? extends Double> entry : map.entrySet())
/*  234 */       put(((Double)entry.getKey()).doubleValue(), ((Double)entry.getValue()).doubleValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TDoubleDoubleMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TDoubleDoubleIterator iter = map.iterator();
...
/*  393 */     return new TDoubleDoubleHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TDoubleDoubleHashMap.TDoubleDoubleKeyHashIterator((TPrimitiveHash)TDoubleDoubleHashMap.this);
/*      */     }
/*      */     
/*      */     public double getNoEntryValue() {
/*  521 */       return TDoubleDoubleHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TDoubleDoubleHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TDoubleDoubleHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(double entry) {
/*  539 */       return TDoubleDoubleHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public double[] toArray() {
/*  545 */       return TDoubleDoubleHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public double[] toArray(double[] dest) {
/*  551 */       return TDoubleDoubleHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TDoubleDoubleHashMap.this.no_entry_value != TDoubleDoubleHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TDoubleDoubleHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TDoubleDoubleHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TDoubleDoubleHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       double[] set = TDoubleDoubleHashMap.this._set;
/*  677 */       byte[] states = TDoubleDoubleHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TDoubleDoubleHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TDoubleDoubleHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TDoubleProcedure procedure) {
/*  742 */       return TDoubleDoubleHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TDoubleDoubleHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TDoubleDoubleHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TDoubleDoubleHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TDoubleDoubleHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TDoubleDoubleHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TDoubleDoubleHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TDoubleDoubleHashMap.this.forEachKey(new TDoubleProcedure() {
...
/*      */     public TDoubleIterator iterator() {
/*  807 */       return new TDoubleDoubleHashMap.TDoubleDoubleValueHashIterator((TPrimitiveHash)TDoubleDoubleHashMap.this);
/*      */     }
/*      */     
/*      */     public double getNoEntryValue() {
/*  813 */       return TDoubleDoubleHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TDoubleDoubleHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TDoubleDoubleHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(double entry) {
/*  831 */       return TDoubleDoubleHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public double[] toArray() {
/*  837 */       return TDoubleDoubleHashMap.this.values();
/*      */     }
/*      */     
/*      */     public double[] toArray(double[] dest) {
/*  843 */       return TDoubleDoubleHashMap.this.values(dest);
/*      */     }
/*      */     
/*      */     public boolean add(double entry) {
...
/*      */     
/*      */     public boolean remove(double entry) {
/*  855 */       double[] values = TDoubleDoubleHashMap.this._values;
/*  856 */       double[] set = TDoubleDoubleHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0.0D && set[i] != 2.0D && entry == values[i]) {
/*  860 */           TDoubleDoubleHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TDoubleDoubleHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TDoubleDoubleHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TDoubleDoubleHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       double[] values = TDoubleDoubleHashMap.this._values;
/*  962 */       byte[] states = TDoubleDoubleHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TDoubleDoubleHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TDoubleDoubleHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TDoubleProcedure procedure) {
/* 1027 */       return TDoubleDoubleHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TDoubleDoubleHashMap.this.forEachValue(new TDoubleProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TDoubleDoubleHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TDoubleDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TDoubleDoubleHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TDoubleDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public double key() {
/* 1148 */       return TDoubleDoubleHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public double value() {
/* 1153 */       return TDoubleDoubleHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public double setValue(double val) {
/* 1158 */       double old = value();
/* 1159 */       TDoubleDoubleHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TDoubleDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TDoubleDoubleMap))
/* 1185 */       return false; 
/* 1187 */     TDoubleDoubleMap that = (TDoubleDoubleMap)other;
...
/* 1230 */     forEachEntry(new TDoubleDoubleProcedure() {
/*      */           private boolean first = true;
/*      */           
/*      */           public boolean execute(double key, double value) {
/* 1233 */             if (this.first) {
/* 1233 */               this.first = false;
/*      */             } else {
/* 1234 */               buf.append(", ");
/*      */             } 
/* 1236 */             buf.append(key);
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TDoubleDoubleHashMap.class
