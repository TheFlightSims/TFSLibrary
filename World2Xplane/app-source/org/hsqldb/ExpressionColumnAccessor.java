...
public class ExpressionColumnAccessor extends Expression {
  ...
  public boolean equals(Expression paramExpression) {
    return (paramExpression == this) ? true : ((paramExpression == null) ? false : ((this.opType != paramExpression.opType) ? false : ((this.column == paramExpression.getColumn()))));
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\ExpressionColumnAccessor.class
