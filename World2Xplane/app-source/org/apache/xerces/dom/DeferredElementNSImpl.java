  ...
  protected final void synchronizeData() {
    ...
    if (j != -1) {
      ...
      do {
        ...
        if (!attrImpl.getSpecified() && (bool1 || (attrImpl.getNamespaceURI() != null && attrImpl.getName().indexOf(':') < 0))) {
          bool1 = true;
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\DeferredElementNSImpl.class
