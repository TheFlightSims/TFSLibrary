...
/*      */         
/*      */         public String toString() {
/*  538 */           return getOwnerType() + "(" + Joiner.on(", ").join((Object[])getGenericParameterTypes()) + ")";
/*      */         }
/*      */       };
/*      */   }
/*      */   
...
/*  728 */           throw new IllegalArgumentException(TypeToken.this.runtimeType + "contains a type variable and is not safe for the operation");
/*      */         }
/*      */         
...
/*  987 */     Type[] arr$ = lowerBounds;
/*  987 */     int len$ = arr$.length, i$ = 0;
/*  987 */     if (i$ < len$) {
/*  987 */       Type lowerBound = arr$[i$];
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\google\common\reflect\TypeToken.class
