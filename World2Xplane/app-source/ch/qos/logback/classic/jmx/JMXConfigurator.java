...
/*  73 */     this.context = (Context)loggerContext;
...
/* 140 */     addStatusListener((StatusListener)statusListenerAsList);
/* 141 */     addInfo("Resetting context: " + this.loggerContext.getName());
/* 142 */     this.loggerContext.reset();
/* 144 */     addStatusListener((StatusListener)statusListenerAsList);
/*     */     try {
/* 147 */       JoranConfigurator configurator = new JoranConfigurator();
/* 148 */       configurator.setContext((Context)this.loggerContext);
/* 149 */       configurator.doConfigure(url);
/* 150 */       addInfo("Context: " + this.loggerContext.getName() + " reloaded.");
/*     */     } finally {
/* 152 */       removeStatusListener((StatusListener)statusListenerAsList);
/* 153 */       if (this.debug)
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\classic\jmx\JMXConfigurator.class
