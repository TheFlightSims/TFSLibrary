...
/*  393 */     return new TLongLongHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TLongLongHashMap.TLongLongKeyHashIterator((TPrimitiveHash)TLongLongHashMap.this);
/*      */     }
/*      */     
/*      */     public long getNoEntryValue() {
/*  521 */       return TLongLongHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TLongLongHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TLongLongHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(long entry) {
/*  539 */       return TLongLongHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public long[] toArray() {
/*  545 */       return TLongLongHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public long[] toArray(long[] dest) {
/*  551 */       return TLongLongHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TLongLongHashMap.this.no_entry_value != TLongLongHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TLongLongHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TLongLongHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TLongLongHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       long[] set = TLongLongHashMap.this._set;
/*  677 */       byte[] states = TLongLongHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TLongLongHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TLongLongHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TLongProcedure procedure) {
/*  742 */       return TLongLongHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TLongLongHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TLongLongHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TLongLongHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TLongLongHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TLongLongHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TLongLongHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TLongLongHashMap.this.forEachKey(new TLongProcedure() {
...
/*      */     public TLongIterator iterator() {
/*  807 */       return new TLongLongHashMap.TLongLongValueHashIterator((TPrimitiveHash)TLongLongHashMap.this);
/*      */     }
/*      */     
/*      */     public long getNoEntryValue() {
/*  813 */       return TLongLongHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TLongLongHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TLongLongHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(long entry) {
/*  831 */       return TLongLongHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public long[] toArray() {
/*  837 */       return TLongLongHashMap.this.values();
/*      */     }
/*      */     
/*      */     public long[] toArray(long[] dest) {
/*  843 */       return TLongLongHashMap.this.values(dest);
/*      */     }
/*      */     
/*      */     public boolean add(long entry) {
...
/*      */     
/*      */     public boolean remove(long entry) {
/*  855 */       long[] values = TLongLongHashMap.this._values;
/*  856 */       long[] set = TLongLongHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0L && set[i] != 2L && entry == values[i]) {
/*  860 */           TLongLongHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TLongLongHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TLongLongHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TLongLongHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       long[] values = TLongLongHashMap.this._values;
/*  962 */       byte[] states = TLongLongHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TLongLongHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TLongLongHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TLongProcedure procedure) {
/* 1027 */       return TLongLongHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TLongLongHashMap.this.forEachValue(new TLongProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TLongLongHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TLongLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TLongLongHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TLongLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public long key() {
/* 1148 */       return TLongLongHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public long value() {
/* 1153 */       return TLongLongHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public long setValue(long val) {
/* 1158 */       long old = value();
/* 1159 */       TLongLongHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TLongLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TLongLongMap))
/* 1185 */       return false; 
/* 1187 */     TLongLongMap that = (TLongLongMap)other;
...
/* 1230 */     forEachEntry(new TLongLongProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TLongLongHashMap.class
