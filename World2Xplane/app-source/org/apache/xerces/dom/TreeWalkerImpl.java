...
public class TreeWalkerImpl implements TreeWalker {
  ...
  Node getNextSibling(Node paramNode1, Node paramNode2) {
    ...
    if (node == null) {
      ...
      if (node == null || isSameNode(node, paramNode2))
        return null; 
  ...
  short acceptNode(Node paramNode) {
    return (this.fNodeFilter == null) ? (((this.fWhatToShow & 1 << paramNode.getNodeType() - 1) != 0) ? 1 : 3) : (((this.fWhatToShow & 1 << paramNode.getNodeType() - 1) != 0) ? this.fNodeFilter.acceptNode(paramNode) : 3);
  }
  ...
  private boolean isSameNode(Node paramNode1, Node paramNode2) {
    return this.fUseIsSameNode ? paramNode1.isSameNode(paramNode2) : ((paramNode1 == paramNode2));
  }
}


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\TreeWalkerImpl.class
