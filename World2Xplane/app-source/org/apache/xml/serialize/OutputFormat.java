...
public class OutputFormat {
  ...
  public char getLastPrintable() {
    return (getEncoding() != null && getEncoding().equalsIgnoreCase("ASCII")) ? 'ÿ' : Character.MAX_VALUE;
  }
  ...
  public static String whichMediaType(String paramString) {
    return paramString.equalsIgnoreCase("xml") ? "text/xml" : (paramString.equalsIgnoreCase("html") ? "text/html" : (paramString.equalsIgnoreCase("xhtml") ? "text/html" : (paramString.equalsIgnoreCase("text") ? "text/plain" : (paramString.equalsIgnoreCase("fop") ? "application/pdf" : null))));
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xml\serialize\OutputFormat.class
