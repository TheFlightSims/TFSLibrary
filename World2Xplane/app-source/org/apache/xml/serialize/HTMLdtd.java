...
public final class HTMLdtd {
  ...
  public static String fromChar(int paramInt) {
    if (paramInt > 65535)
      return null; 
    initialize();
    return (String)_byChar.get(new Integer(paramInt));
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xml\serialize\HTMLdtd.class
