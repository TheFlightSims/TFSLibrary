...
public class XSModelGroupImpl implements XSModelGroup {
  ...
  public short getCompositor() {
    return (this.fCompositor == 101) ? 2 : ((this.fCompositor == 102) ? 1 : 3);
  }
  
  public XSObjectList getParticles() {
    return (XSObjectList)new XSObjectListImpl((XSObject[])this.fParticles, this.fParticleCount);
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xs\XSModelGroupImpl.class
