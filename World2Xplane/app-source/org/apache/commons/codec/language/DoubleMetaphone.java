...
/*      */   
/*   51 */   private static final String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = new String[] { 
/*   51 */       "ES", "EP", "EB", "EL", "EY", "IB", "IL", "IN", "IE", "EI", 
/*   51 */       "ER" };
/*      */   
...
/*  287 */     } else if (contains(value, index, 2, new String[] { "CZ" }) && !contains(value, index - 2, 4, new String[] { "WICZ" })) {
...
/*  295 */       index += 3;
/*      */     } else {
/*  296 */       if (contains(value, index, 2, new String[] { "CC" }) && (index != 1 || charAt(value, 0) != 'M'))
...
/*  315 */           index += 3;
/*  316 */         } else if (contains(value, index + 1, 1, new String[] { "C", "K", "Q" }) && !contains(value, index + 1, 2, new String[] { "CE", "CI" })) {
/*  318 */           index += 2;
/*      */         } else {
/*  320 */           index++;
/*      */         } 
...
/*  331 */     if (contains(value, index + 2, 1, new String[] { "I", "E", "H" }) && !contains(value, index + 2, 2, new String[] { "HU" })) {
/*  334 */       if ((index == 1 && charAt(value, index - 1) == 'A') || contains(value, index - 1, 5, new String[] { "UCCEE", "UCCES" })) {
...
/*  414 */       } else if (!contains(value, index + 2, 2, new String[] { "EY" }) && charAt(value, index + 1) != 'Y' && !slavoGermanic) {
...
/*  423 */       index += 2;
/*  424 */     } else if (index == 0 && (charAt(value, index + 1) == 'Y' || contains(value, index + 1, 2, ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER))) {
/*  428 */       result.append('K', 'J');
/*  429 */       index += 2;
/*  430 */     } else if ((contains(value, index + 1, 2, new String[] { "ER" }) || charAt(value, index + 1) == 'Y') && !contains(value, 0, 6, new String[] { "DANGER", "RANGER", "MANGER" }) && !contains(value, index - 1, 1, new String[] { "E", "I" }) && !contains(value, index - 1, 3, new String[] { "RGY", "OGY" })) {
/*  436 */       result.append('K', 'J');
/*  437 */       index += 2;
/*  438 */     } else if (contains(value, index + 1, 1, new String[] { "E", "I", "Y" }) || contains(value, index - 1, 4, new String[] { "AGGI", "OGGI" })) {
/*  441 */       if (contains(value, 0, 4, new String[] { "VAN ", "VON " }) || contains(value, 0, 3, new String[] { "SCH" }) || contains(value, index + 1, 2, new String[] { "ET" })) {
/*  445 */         result.append('K');
...
/*      */       } 
/*  475 */       index += 2;
/*  476 */     } else if ((index > 1 && contains(value, index - 2, 1, new String[] { "B", "H", "D" })) || (index > 2 && contains(value, index - 3, 1, new String[] { "B", "H", "D" })) || (index > 3 && contains(value, index - 4, 1, new String[] { "B", "H" }))) {
/*  480 */       index += 2;
/*      */     } else {
/*  482 */       if (index > 2 && charAt(value, index - 1) == 'U' && contains(value, index - 3, 1, new String[] { "C", "G", "L", "R", "T" })) {
/*  485 */         result.append('F');
...
/*  499 */     if ((index == 0 || isVowel(charAt(value, index - 1))) && isVowel(charAt(value, index + 1))) {
/*  501 */       result.append('H');
/*  502 */       index += 2;
/*      */     } else {
/*  505 */       index++;
...
/*  517 */       if ((index == 0 && charAt(value, index + 4) == ' ') || value.length() == 4 || contains(value, 0, 4, new String[] { "SAN " })) {
/*  519 */         result.append('H');
/*      */       } else {
...
/*  527 */       } else if (isVowel(charAt(value, index - 1)) && !slavoGermanic && (charAt(value, index + 1) == 'A' || charAt(value, index + 1) == 'O')) {
/*  529 */         result.append('J', 'H');
/*  530 */       } else if (index == value.length() - 1) {
/*  531 */         result.append('J', ' ');
/*  532 */       } else if (!contains(value, index + 1, 1, L_T_K_S_N_M_B_Z) && !contains(value, index - 1, 1, new String[] { "S", "K", "L" })) {
/*  534 */         result.append('J');
/*      */       } 
...
/*  583 */     if (index == value.length() - 1 && !slavoGermanic && contains(value, index - 2, 2, new String[] { "IE" }) && !contains(value, index - 4, 2, new String[] { "ME", "MA" })) {
...
/*      */       } 
/*  620 */       index += 3;
/*  621 */     } else if ((index == 0 && contains(value, index + 1, 1, new String[] { "M", "N", "L", "W" })) || contains(value, index + 1, 1, new String[] { "Z" })) {
...
/*  683 */       if (contains(value, index + 2, 2, new String[] { "OM", "AM" }) || contains(value, 0, 4, new String[] { "VAN ", "VON " }) || contains(value, 0, 3, new String[] { "SCH" })) {
/*  687 */         result.append('T');
/*      */       } else {
...
/*  705 */       result.append('R');
/*  706 */       index += 2;
/*  708 */     } else if (index == 0 && (isVowel(charAt(value, index + 1)) || contains(value, index, 2, new String[] { "WH" }))) {
...
/*      */       } 
/*  717 */       index++;
/*  718 */     } else if ((index == value.length() - 1 && isVowel(charAt(value, index - 1))) || contains(value, index - 1, 5, new String[] { "EWSKI", "EWSKY", "OWSKI", "OWSKY" }) || contains(value, 0, 3, new String[] { "SCH" })) {
...
/*  741 */       index++;
/*      */     } else {
/*  743 */       if (index != value.length() - 1 || (!contains(value, index - 3, 3, new String[] { "IAU", "EAU" }) && !contains(value, index - 2, 2, new String[] { "AU", "OU" })))
...
/*  762 */       index += 2;
/*      */     } else {
/*  764 */       if (contains(value, index + 1, 2, new String[] { "ZO", "ZI", "ZA" }) || (slavoGermanic && index > 0 && charAt(value, index - 1) != 'T')) {
...
/*  791 */     return ((c != 'I' && c != 'E') || contains(value, index - 2, 6, new String[] { "BACHER", "MACHER" }));
/*      */   }
/*      */   
/*      */   private boolean conditionCH0(String value, int index) {
/*  800 */     if (index != 0)
/*  801 */       return false; 
/*  802 */     if (!contains(value, index + 1, 5, new String[] { "HARAC", "HARIS" }) && !contains(value, index + 1, 3, new String[] { "HOR", "HYM", "HIA", "HEM" }))
/*  804 */       return false; 
...
/*  816 */     return (contains(value, 0, 4, new String[] { "VAN ", "VON " }) || contains(value, 0, 3, new String[] { "SCH" }) || contains(value, index - 2, 6, new String[] { "ORCHES", "ARCHIT", "ORCHID" }) || contains(value, index + 2, 1, new String[] { "T", "S" }) || ((contains(value, index - 1, 1, new String[] { "A", "O", "U", "E" }) || index == 0) && (contains(value, index + 2, 1, L_R_N_M_B_H_F_V_W_SPACE) || index + 1 == value.length() - 1)));
/*      */   }
/*      */   
/*      */   private boolean conditionL0(String value, int index) {
/*  827 */     if (index == value.length() - 3 && contains(value, index - 1, 4, new String[] { "ILLO", "ILLA", "ALLE" }))
/*  829 */       return true; 
/*  830 */     if ((contains(value, value.length() - 2, 2, new String[] { "AS", "OS" }) || contains(value, value.length() - 1, 1, new String[] { "A", "O" })) && contains(value, index - 1, 4, new String[] { "ALLE" }))
/*  833 */       return true; 
/*  835 */     return false;
/*      */   }
/*      */   
...
/*  844 */       return true; 
/*  846 */     return (contains(value, index - 1, 3, new String[] { "UMB" }) && (index + 1 == value.length() - 1 || contains(value, index + 2, 2, new String[] { "ER" })));
/*      */   }
/*      */   
/*      */   private boolean isSlavoGermanic(String value) {
/*  857 */     return (value.indexOf('W') > -1 || value.indexOf('K') > -1 || value.indexOf("CZ") > -1 || value.indexOf("WITZ") > -1);
/*      */   }
/*      */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\codec\language\DoubleMetaphone.class
