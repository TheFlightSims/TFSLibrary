...
/* 55 */       return (scala.runtime.Nothing$)scala.collection.Iterator$.MODULE$.empty().next();
/*    */     }
/*    */     
/*    */     public Seq<Object> split() {
/* 56 */       (new Splitter[1])[0] = this;
/* 56 */       return (Seq<Object>)scala.collection.Seq$.MODULE$.apply((Seq)scala.Predef$.MODULE$.wrapRefArray((Object[])new Splitter[1]));
/*    */     }
/*    */   }
/*    */ }
