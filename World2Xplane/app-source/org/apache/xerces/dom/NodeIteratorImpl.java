...
public class NodeIteratorImpl implements NodeIterator {
  ...
  boolean acceptNode(Node paramNode) {
    return (this.fNodeFilter == null) ? (((this.fWhatToShow & 1 << paramNode.getNodeType() - 1) != 0)) : (((this.fWhatToShow & 1 << paramNode.getNodeType() - 1) != 0 && this.fNodeFilter.acceptNode(paramNode) == 1));
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\NodeIteratorImpl.class
