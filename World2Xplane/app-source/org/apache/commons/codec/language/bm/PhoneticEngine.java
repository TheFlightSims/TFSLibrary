...
/* 241 */     NAME_PREFIXES.put(NameType.SEPHARDIC, Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(new String[] { 
/* 241 */                 "al", "el", "da", "dal", "de", "del", "dela", "de la", "della", "des", 
/* 241 */                 "di", "do", "dos", "du", "van", "von" }))));
/* 245 */     NAME_PREFIXES.put(NameType.GENERIC, Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(new String[] { 
/* 245 */                 "da", "dal", "de", "del", "dela", "de la", "della", "des", "di", "do", 
/* 245 */                 "dos", "du", "van", "von" }))));
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\codec\language\bm\PhoneticEngine.class
