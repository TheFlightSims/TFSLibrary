...
/*     */   
/*  96 */   private static final ByteOrderMark[] XML_GUESS_BYTES = new ByteOrderMark[] { new ByteOrderMark("UTF-8", new int[] { 60, 63, 120, 109 }), new ByteOrderMark("UTF-16BE", new int[] { 0, 60, 0, 63 }), new ByteOrderMark("UTF-16LE", new int[] { 60, 0, 63, 0 }), new ByteOrderMark("UTF-32BE", new int[] { 
/*  96 */           0, 0, 0, 60, 0, 0, 0, 63, 0, 0, 
/*  96 */           0, 120, 0, 0, 0, 109 }), new ByteOrderMark("UTF-32LE", new int[] { 
/*  96 */           60, 0, 0, 0, 63, 0, 0, 0, 120, 0, 
/*  96 */           0, 0, 109, 0, 0, 0 }), new ByteOrderMark("CP1047", new int[] { 76, 111, 167, 148 }) };
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\io\input\XmlStreamReader.class
