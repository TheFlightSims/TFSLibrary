...
/*  393 */     return new TShortIntHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TShortIntHashMap.TShortIntKeyHashIterator((TPrimitiveHash)TShortIntHashMap.this);
/*      */     }
/*      */     
/*      */     public short getNoEntryValue() {
/*  521 */       return TShortIntHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TShortIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TShortIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(short entry) {
/*  539 */       return TShortIntHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public short[] toArray() {
/*  545 */       return TShortIntHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public short[] toArray(short[] dest) {
/*  551 */       return TShortIntHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TShortIntHashMap.this.no_entry_value != TShortIntHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TShortIntHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TShortIntHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TShortIntHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       short[] set = TShortIntHashMap.this._set;
/*  677 */       byte[] states = TShortIntHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TShortIntHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TShortIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TShortProcedure procedure) {
/*  742 */       return TShortIntHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TShortIntHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TShortIntHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TShortIntHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TShortIntHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TShortIntHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TShortIntHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TShortIntHashMap.this.forEachKey(new TShortProcedure() {
...
/*  807 */       return new TShortIntHashMap.TShortIntValueHashIterator((TPrimitiveHash)TShortIntHashMap.this);
/*      */     }
/*      */     
/*      */     public int getNoEntryValue() {
/*  813 */       return TShortIntHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TShortIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TShortIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(int entry) {
/*  831 */       return TShortIntHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public int[] toArray() {
/*  837 */       return TShortIntHashMap.this.values();
/*      */     }
/*      */     
/*      */     public int[] toArray(int[] dest) {
/*  843 */       return TShortIntHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       int[] values = TShortIntHashMap.this._values;
/*  856 */       short[] set = TShortIntHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0 && set[i] != 2 && entry == values[i]) {
/*  860 */           TShortIntHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TShortIntHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TShortIntHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TShortIntHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       int[] values = TShortIntHashMap.this._values;
/*  962 */       byte[] states = TShortIntHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TShortIntHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TShortIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TIntProcedure procedure) {
/* 1027 */       return TShortIntHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TShortIntHashMap.this.forEachValue(new TIntProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TShortIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TShortIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TShortIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TShortIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public short key() {
/* 1148 */       return TShortIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public int value() {
/* 1153 */       return TShortIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public int setValue(int val) {
/* 1158 */       int old = value();
/* 1159 */       TShortIntHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TShortIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TShortIntMap))
/* 1185 */       return false; 
/* 1187 */     TShortIntMap that = (TShortIntMap)other;
...
/* 1230 */     forEachEntry(new TShortIntProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TShortIntHashMap.class
