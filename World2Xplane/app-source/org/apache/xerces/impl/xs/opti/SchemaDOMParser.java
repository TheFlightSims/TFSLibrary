...
public class SchemaDOMParser extends DefaultXMLDocumentHandler {
  ...
  private XMLAttributes fEmptyAttr = (XMLAttributes)new XMLAttributesImpl();
  ...
  public void emptyElement(QName paramQName, XMLAttributes paramXMLAttributes, Augmentations paramAugmentations) throws XNIException {
    if (this.fGenerateSyntheticAnnotation && this.fAnnotationDepth == -1 && paramQName.uri == SchemaSymbols.URI_SCHEMAFORSCHEMA && paramQName.localpart != SchemaSymbols.ELT_ANNOTATION && hasNonSchemaAttributes(paramQName, paramXMLAttributes)) {
      ...
      QName qName1 = new QName(str, SchemaSymbols.ELT_ANNOTATION, str + ((str.length() == 0) ? "" : ":") + SchemaSymbols.ELT_ANNOTATION, SchemaSymbols.URI_SCHEMAFORSCHEMA);
      this.schemaDOM.startAnnotation(qName1, paramXMLAttributes, this.fNamespaceContext);
      QName qName2 = new QName(str, SchemaSymbols.ELT_DOCUMENTATION, str + ((str.length() == 0) ? "" : ":") + SchemaSymbols.ELT_DOCUMENTATION, SchemaSymbols.URI_SCHEMAFORSCHEMA);
      this.schemaDOM.startAnnotationElement(qName2, paramXMLAttributes);
      this.schemaDOM.characters(new XMLString("SYNTHETIC_ANNOTATION".toCharArray(), 0, 20));
      this.schemaDOM.endSyntheticAnnotationElement(qName2, false);
      this.schemaDOM.endSyntheticAnnotationElement(qName1, true);
    ...
    if (this.fAnnotationDepth > -1) {
      ...
      if (paramQName.uri == SchemaSymbols.URI_SCHEMAFORSCHEMA && this.fGenerateSyntheticAnnotation) {
        ...
        if (bool1 && !bool2) {
          String str = this.fNamespaceContext.getPrefix(SchemaSymbols.URI_SCHEMAFORSCHEMA);
          QName qName1 = new QName(str, SchemaSymbols.ELT_ANNOTATION, str + ((str.length() == 0) ? "" : ":") + SchemaSymbols.ELT_ANNOTATION, SchemaSymbols.URI_SCHEMAFORSCHEMA);
          this.schemaDOM.startAnnotation(qName1, this.fEmptyAttr, this.fNamespaceContext);
          QName qName2 = new QName(str, SchemaSymbols.ELT_DOCUMENTATION, str + ((str.length() == 0) ? "" : ":") + SchemaSymbols.ELT_DOCUMENTATION, SchemaSymbols.URI_SCHEMAFORSCHEMA);
          this.schemaDOM.startAnnotationElement(qName2, this.fEmptyAttr);
          this.schemaDOM.characters(new XMLString("SYNTHETIC_ANNOTATION".toCharArray(), 0, 20));
          this.schemaDOM.endSyntheticAnnotationElement(qName2, false);
          this.schemaDOM.endSyntheticAnnotationElement(qName1, true);
        } 
  ...
  public void parse(XMLInputSource paramXMLInputSource) throws IOException {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xs\opti\SchemaDOMParser.class
