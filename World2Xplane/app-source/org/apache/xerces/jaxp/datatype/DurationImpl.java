...
class DurationImpl extends Duration implements Serializable {
  ...
  private int calcSignum(boolean paramBoolean) {
    return ((this.years == null || this.years.signum() == 0) && (this.months == null || this.months.signum() == 0) && (this.days == null || this.days.signum() == 0) && (this.hours == null || this.hours.signum() == 0) && (this.minutes == null || this.minutes.signum() == 0) && (this.seconds == null || this.seconds.signum() == 0)) ? 0 : (paramBoolean ? 1 : -1);
  }
  ...
  private static BigInteger wrap(int paramInt) {
    return (paramInt == Integer.MIN_VALUE) ? null : new BigInteger(String.valueOf(paramInt));
  }
  ...
  protected DurationImpl(long paramLong) {
    ...
    this.years = null;
    this.months = null;
    this.seconds = BigDecimal.valueOf(l % 60000L + (bool ? 1L : 0L), 3);
    l /= 60000L;
  ...
  public int compare(Duration paramDuration) {
    BigInteger bigInteger1 = BigInteger.valueOf(2147483647L);
    BigInteger bigInteger2 = BigInteger.valueOf(-2147483648L);
  ...
  private int compareResults(int paramInt1, int paramInt2) {
    return (paramInt2 == 2) ? 2 : ((paramInt1 != paramInt2) ? 2 : paramInt1);
  }
  ...
  private static BigInteger toBigInteger(BigDecimal paramBigDecimal, boolean paramBoolean) {
    return (paramBoolean && paramBigDecimal.signum() == 0) ? null : paramBigDecimal.unscaledValue();
  }
  ...
  private static BigDecimal sanitize(BigInteger paramBigInteger, int paramInt) {
    return (paramInt == 0 || paramBigInteger == null) ? ZERO : ((paramInt > 0) ? new BigDecimal(paramBigInteger) : new BigDecimal(paramBigInteger.negate()));
  }
  
  static BigDecimal sanitize(BigDecimal paramBigDecimal, int paramInt) {
    return (paramInt == 0 || paramBigDecimal == null) ? ZERO : ((paramInt > 0) ? paramBigDecimal : paramBigDecimal.negate());
  }
  ...
  private static class DurationStream implements Serializable {
    ...
    private DurationStream(String param1String) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\jaxp\datatype\DurationImpl.class
