...
public class TimeData {
  ...
  public boolean equals(Object paramObject) {
    return (paramObject instanceof TimeData) ? ((this.seconds == ((TimeData)paramObject).seconds && this.nanos == ((TimeData)paramObject).nanos && this.zone == ((TimeData)paramObject).zone)) : false;
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\types\TimeData.class
