...
/*      */   
/*   58 */   private final TObjectLongProcedure<K> PUT_ALL_PROC = new TObjectLongProcedure<K>() {
...
/*  426 */     return new TObjectLongHashIterator<K>(this);
/*      */   }
/*      */   
...
/*  458 */     index = -index - 1;
/*  459 */     long newValue = this._values[index] = this._values[index] + adjust_amount;
...
/*  594 */       return false; 
/*      */     try {
/*  597 */       TObjectLongIterator<K> iter = iterator();
...
/*  641 */       return (Iterator<K>)new TObjectHashIterator((TObjectHash)TObjectLongCustomHashMap.this);
/*      */     }
/*      */     
...
/*  967 */       protected THash _hash = (THash)TObjectLongCustomHashMap.this;
/*      */       
...
/* 1149 */     forEachEntry(new TObjectLongProcedure<K>() {
/*      */           private boolean first = true;
/*      */           
/*      */           public boolean execute(K key, long value) {
/* 1152 */             if (this.first) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\custom_hash\TObjectLongCustomHashMap.class
