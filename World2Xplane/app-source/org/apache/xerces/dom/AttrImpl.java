    ...
    if (this.value != null) {
      if (coreDocumentImpl.getMutationEvents()) {
        if (hasStringValue()) {
          ...
          if (textNode == null) {
            textNode = (TextImpl)coreDocumentImpl.createTextNode((String)this.value);
          } else {
  ...
  Node internalInsertBefore(Node paramNode1, Node paramNode2, boolean paramBoolean) throws DOMException {
    ...
    if (bool) {
      ...
      while (bool1 && attrImpl != null) {
        bool1 = (paramNode1 != attrImpl) ? true : false;
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\AttrImpl.class
