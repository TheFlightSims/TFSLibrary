...
/*  67 */       this.contextSelector = (ContextSelector)new DefaultContextSelector(defaultLoggerContext);
/*  68 */     } else if (contextSelectorStr.equals("JNDI")) {
/*  70 */       this.contextSelector = (ContextSelector)new ContextJNDISelector(defaultLoggerContext);
/*     */     } else {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\classi\\util\ContextSelectorStaticBinder.class
