...
public class Quat4d extends Tuple4d implements Serializable {
  ...
  public final void mulInverse(Quat4d paramQuat4d1, Quat4d paramQuat4d2) {
    Quat4d quat4d = new Quat4d(paramQuat4d2);
    quat4d.inverse();
    mul(paramQuat4d1, quat4d);
  }
  
  public final void mulInverse(Quat4d paramQuat4d) {
    Quat4d quat4d = new Quat4d(paramQuat4d);
    quat4d.inverse();
    mul(quat4d);
  }
  ...
  public final void set(AxisAngle4f paramAxisAngle4f) {
    ...
    if (d < 1.0E-6D) {
      ...
      this.x = paramAxisAngle4f.x * d * d1;
      this.y = paramAxisAngle4f.y * d * d1;
      this.z = paramAxisAngle4f.z * d * d1;
    } 
  }
  ...
  public final void set(AxisAngle4d paramAxisAngle4d) {
    ...
    if (d < 1.0E-6D) {
      ...
      this.x = paramAxisAngle4d.x * d * d1;
      this.y = paramAxisAngle4d.y * d * d1;
      this.z = paramAxisAngle4d.z * d * d1;
    } 
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\javax\vecmath\Quat4d.class
