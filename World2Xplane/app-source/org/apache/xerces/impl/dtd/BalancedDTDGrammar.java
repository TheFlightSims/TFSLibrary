...
final class BalancedDTDGrammar extends DTDGrammar {
  ...
  public final void pcdata(Augmentations paramAugmentations) throws XNIException {
    this.fMixed = true;
  }
  
  public final void element(String paramString, Augmentations paramAugmentations) throws XNIException {
  ...
  protected final void addContentSpecToElement(XMLElementDecl paramXMLElementDecl) {
    boolean bool = (this.fGroupIndexStackSizes[0] > 0) ? this.fGroupIndexStack[0][0] : true;
    setContentSpecIndex(this.fCurrentElementIndex, bool);
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\dtd\BalancedDTDGrammar.class
