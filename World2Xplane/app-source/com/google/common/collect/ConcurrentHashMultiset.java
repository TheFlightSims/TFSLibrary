...
/* 479 */     if (result == null)
/* 480 */       this.entrySet = result = new EntrySet(); 
/* 482 */     return result;
/*     */   }
/*     */   
...
/* 490 */     return this.countMap.isEmpty();
/*     */   }
/*     */   
/*     */   Iterator<Multiset.Entry<E>> entryIterator() {
/* 496 */     final Iterator<Multiset.Entry<E>> readOnlyIterator = new AbstractIterator<Multiset.Entry<E>>() {
/* 498 */         private Iterator<Map.Entry<E, AtomicInteger>> mapEntries = ConcurrentHashMultiset.this.countMap.entrySet().iterator();
/*     */         
/*     */         protected Multiset.Entry<E> computeNext() {
/*     */           while (true) {
/* 502 */             if (!this.mapEntries.hasNext())
/* 503 */               return endOfData(); 
/* 505 */             Map.Entry<E, AtomicInteger> mapEntry = this.mapEntries.next();
/* 506 */             int count = ((AtomicInteger)mapEntry.getValue()).get();
/* 507 */             if (count != 0)
...
/* 522 */           this.last = super.next();
/* 523 */           return this.last;
/*     */         }
/*     */         
/*     */         public void remove() {
/* 527 */           CollectPreconditions.checkRemove((this.last != null));
/* 528 */           ConcurrentHashMultiset.this.setCount(this.last.getElement(), 0);
/* 529 */           this.last = null;
/*     */         }
/*     */       };
/*     */   }
...
/* 575 */     ConcurrentMap<E, Integer> deserializedCountMap = (ConcurrentMap<E, Integer>)stream.readObject();
/* 577 */     FieldSettersHolder.COUNT_MAP_FIELD_SETTER.set(this, deserializedCountMap);
/*     */   }
/*     */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\google\common\collect\ConcurrentHashMultiset.class
