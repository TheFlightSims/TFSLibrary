...
/*     */   
/*  48 */   final List<InPlayListener> listenerList = new ArrayList<InPlayListener>();
/*     */   
...
/*  55 */     this.objectMap = new HashMap<String, Object>(5);
/*  56 */     this.propertiesMap = new HashMap<String, String>(5);
/*     */   }
/*     */   
...
/*  65 */     return new HashMap<String, String>(this.propertiesMap);
/*     */   }
/*     */   
...
/* 147 */     String v = this.propertiesMap.get(key);
/* 148 */     if (v != null)
/* 149 */       return v; 
...
/* 156 */     if (value == null)
/* 157 */       return null; 
/* 159 */     return OptionHelper.substVars(value, this, (PropertyContainer)this.context);
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\joran\spi\InterpretationContext.class
