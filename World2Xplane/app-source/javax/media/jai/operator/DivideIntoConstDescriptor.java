...
/*     */   
/* 111 */   private static final Object[] paramDefaults = new Object[] { NO_PARAMETER_DEFAULT };
/*     */   
...
/* 139 */     if (length < 1) {
/* 140 */       message.append(getName() + " " + JaiI18N.getString("DivideIntoConstDescriptor2"));
/* 142 */       return false;
/*     */     } 
/* 145 */     return true;
/*     */   }
...
/* 171 */     ParameterBlockJAI pb = new ParameterBlockJAI("DivideIntoConst", "rendered");
/* 175 */     pb.setSource("source0", source0);
/* 177 */     pb.setParameter("constants", constants);
/* 179 */     return JAI.create("DivideIntoConst", (ParameterBlock)pb, hints);
/*     */   }
/*     */   
/*     */   public static RenderableOp createRenderable(RenderableImage source0, double[] constants, RenderingHints hints) {
/* 204 */     ParameterBlockJAI pb = new ParameterBlockJAI("DivideIntoConst", "renderable");
/* 208 */     pb.setSource("source0", source0);
/* 210 */     pb.setParameter("constants", constants);
/* 212 */     return JAI.createRenderable("DivideIntoConst", (ParameterBlock)pb, hints);
/*     */   }
/*     */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\javax\media\jai\operator\DivideIntoConstDescriptor.class
