...
public class XMLDTDValidator implements XMLComponent, XMLDocumentFilter, XMLDTDValidatorFilter, RevalidationHandler {
  ...
  public void doctypeDecl(String paramString1, String paramString2, String paramString3, Augmentations paramAugmentations) throws XNIException {
    ...
    this.fDTDGrammar = this.fGrammarBucket.getGrammar((XMLGrammarDescription)xMLDTDDescription);
    if (this.fDTDGrammar == null && this.fGrammarPool != null && (paramString3 != null || paramString2 != null))
      this.fDTDGrammar = (DTDGrammar)this.fGrammarPool.retrieveGrammar((XMLGrammarDescription)xMLDTDDescription); 
  ...
  protected void addDTDDefaultAttrsAndValidate(QName paramQName, int paramInt, XMLAttributes paramXMLAttributes) throws XNIException {
    ...
    for (int i = this.fDTDGrammar.getFirstAttributeDeclIndex(paramInt); i != -1; i = this.fDTDGrammar.getNextAttributeDeclIndex(i)) {
      ...
      boolean bool1 = false;
      boolean bool2 = (s == 2) ? true : false;
      boolean bool3 = (str4 == XMLSymbols.fCDATASymbol) ? true : false;
  ...
  protected void validateDTDattribute(QName paramQName, String paramString, XMLAttributeDecl paramXMLAttributeDecl) throws XNIException {
    ...
    switch (paramXMLAttributeDecl.simpleType.type) {
      case 1:
        ...
        try {
          if (bool) {
            this.fValENTITIES.validate(paramString, (ValidationContext)this.fValidationState);
            break;
          } 
          this.fValENTITY.validate(paramString, (ValidationContext)this.fValidationState);
      ...
      case 3:
        try {
          this.fValID.validate(paramString, (ValidationContext)this.fValidationState);
        } catch (InvalidDatatypeValueException invalidDatatypeValueException) {
          this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", invalidDatatypeValueException.getKey(), invalidDatatypeValueException.getArgs(), (short)1);
        } 
        break;
      case 4:
        ...
        try {
          if (bool) {
            this.fValIDRefs.validate(paramString, (ValidationContext)this.fValidationState);
            break;
          } 
          this.fValIDRef.validate(paramString, (ValidationContext)this.fValidationState);
        } catch (InvalidDatatypeValueException invalidDatatypeValueException) {
          if (bool) {
      ...
      case 5:
        ...
        try {
          if (bool) {
            this.fValNMTOKENS.validate(paramString, (ValidationContext)this.fValidationState);
            break;
          } 
          this.fValNMTOKEN.validate(paramString, (ValidationContext)this.fValidationState);
        } catch (InvalidDatatypeValueException invalidDatatypeValueException) {
          if (bool) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\dtd\XMLDTDValidator.class
