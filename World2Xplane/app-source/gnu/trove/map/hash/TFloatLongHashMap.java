...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TFloatLongHashMap) {
/*  134 */       TFloatLongHashMap hashmap = (TFloatLongHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Float, ? extends Long> entry : map.entrySet())
/*  234 */       put(((Float)entry.getKey()).floatValue(), ((Long)entry.getValue()).longValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TFloatLongMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TFloatLongIterator iter = map.iterator();
...
/*  393 */     return new TFloatLongHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TFloatLongHashMap.TFloatLongKeyHashIterator((TPrimitiveHash)TFloatLongHashMap.this);
/*      */     }
/*      */     
/*      */     public float getNoEntryValue() {
/*  521 */       return TFloatLongHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TFloatLongHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TFloatLongHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(float entry) {
/*  539 */       return TFloatLongHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public float[] toArray() {
/*  545 */       return TFloatLongHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public float[] toArray(float[] dest) {
/*  551 */       return TFloatLongHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TFloatLongHashMap.this.no_entry_value != TFloatLongHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TFloatLongHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TFloatLongHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TFloatLongHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       float[] set = TFloatLongHashMap.this._set;
/*  677 */       byte[] states = TFloatLongHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TFloatLongHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TFloatLongHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TFloatProcedure procedure) {
/*  742 */       return TFloatLongHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TFloatLongHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TFloatLongHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TFloatLongHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TFloatLongHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TFloatLongHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TFloatLongHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TFloatLongHashMap.this.forEachKey(new TFloatProcedure() {
...
/*  807 */       return new TFloatLongHashMap.TFloatLongValueHashIterator((TPrimitiveHash)TFloatLongHashMap.this);
/*      */     }
/*      */     
/*      */     public long getNoEntryValue() {
/*  813 */       return TFloatLongHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TFloatLongHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TFloatLongHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(long entry) {
/*  831 */       return TFloatLongHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public long[] toArray() {
/*  837 */       return TFloatLongHashMap.this.values();
/*      */     }
/*      */     
/*      */     public long[] toArray(long[] dest) {
/*  843 */       return TFloatLongHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       long[] values = TFloatLongHashMap.this._values;
/*  856 */       float[] set = TFloatLongHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0.0F && set[i] != 2.0F && entry == values[i]) {
/*  860 */           TFloatLongHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TFloatLongHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TFloatLongHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TFloatLongHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       long[] values = TFloatLongHashMap.this._values;
/*  962 */       byte[] states = TFloatLongHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TFloatLongHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TFloatLongHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TLongProcedure procedure) {
/* 1027 */       return TFloatLongHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TFloatLongHashMap.this.forEachValue(new TLongProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TFloatLongHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TFloatLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TFloatLongHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TFloatLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public float key() {
/* 1148 */       return TFloatLongHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public long value() {
/* 1153 */       return TFloatLongHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public long setValue(long val) {
/* 1158 */       long old = value();
/* 1159 */       TFloatLongHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TFloatLongHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TFloatLongMap))
/* 1185 */       return false; 
/* 1187 */     TFloatLongMap that = (TFloatLongMap)other;
...
/* 1230 */     forEachEntry(new TFloatLongProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TFloatLongHashMap.class
