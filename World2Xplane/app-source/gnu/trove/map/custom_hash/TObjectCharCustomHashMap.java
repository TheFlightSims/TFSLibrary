...
/*      */   
/*   58 */   private final TObjectCharProcedure<K> PUT_ALL_PROC = new TObjectCharProcedure<K>() {
...
/*  135 */     if (this.no_entry_value != '\000')
...
/*  158 */       if (this.no_entry_value != '\000')
...
/*  426 */     return new TObjectCharHashIterator<K>(this);
/*      */   }
/*      */   
...
/*  441 */     if (index < 0)
/*  442 */       return false; 
/*  444 */     this._values[index] = (char)(this._values[index] + amount);
/*  445 */     return true;
/*      */   }
/*      */   
...
/*  457 */     if (index < 0) {
/*  458 */       index = -index - 1;
/*  459 */       newValue = this._values[index] = (char)(this._values[index] + adjust_amount);
...
/*  594 */       return false; 
/*      */     try {
/*  597 */       TObjectCharIterator<K> iter = iterator();
...
/*  641 */       return (Iterator<K>)new TObjectHashIterator((TObjectHash)TObjectCharCustomHashMap.this);
/*      */     }
/*      */     
...
/*  967 */       protected THash _hash = (THash)TObjectCharCustomHashMap.this;
/*      */       
...
/* 1149 */     forEachEntry(new TObjectCharProcedure<K>() {
/*      */           private boolean first = true;
/*      */           
/*      */           public boolean execute(K key, char value) {
/* 1152 */             if (this.first) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\custom_hash\TObjectCharCustomHashMap.class
