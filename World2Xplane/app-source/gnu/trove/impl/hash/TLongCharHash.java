...
/*     */ 
/*     */ public abstract class TLongCharHash extends TPrimitiveHash {
...
/*  80 */     this.no_entry_key = 0L;
/*  81 */     this.no_entry_value = Character.MIN_VALUE;
/*     */   }
/*     */   
/*     */   public TLongCharHash(int initialCapacity) {
/*  93 */     super(initialCapacity);
/*  94 */     this.no_entry_key = 0L;
/*  95 */     this.no_entry_value = Character.MIN_VALUE;
/*     */   }
/*     */   
/*     */   public TLongCharHash(int initialCapacity, float loadFactor) {
/* 108 */     super(initialCapacity, loadFactor);
/* 109 */     this.no_entry_key = 0L;
/* 110 */     this.no_entry_value = Character.MIN_VALUE;
/*     */   }
/*     */   
...
/* 166 */     this._set = new long[capacity];
/* 167 */     return capacity;
/*     */   }
/*     */   
...
/* 443 */     out.writeLong(this.no_entry_key);
/* 446 */     out.writeChar(this.no_entry_value);
/*     */   }
/*     */   
/*     */   public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
/* 453 */     in.readByte();
/* 456 */     super.readExternal(in);
/* 459 */     this.no_entry_key = in.readLong();
/* 462 */     this.no_entry_value = in.readChar();
/*     */   }
/*     */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\impl\hash\TLongCharHash.class
