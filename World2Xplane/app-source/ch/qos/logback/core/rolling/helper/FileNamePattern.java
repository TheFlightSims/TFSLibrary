...
/*  66 */       Parser<Object> p = new Parser(patternForParsing, (IEscapeUtil)new AlmostAsIsEscapeUtil());
/*  67 */       p.setContext(this.context);
/*  68 */       Node t = p.parse();
/*  69 */       this.headTokenConverter = p.compile(t, CONVERTER_MAP);
/*  71 */     } catch (ScanException sce) {
/*  72 */       addError("Failed to parse pattern \"" + this.pattern + "\".", (Throwable)sce);
/*     */     } 
/*     */   }
/*     */   
...
/*  85 */     Converter<Object> p = this.headTokenConverter;
/*  87 */     while (p != null) {
...
/* 102 */     Converter<Object> p = this.headTokenConverter;
/* 104 */     while (p != null) {
...
/* 167 */     while (p != null) {
/* 168 */       if (p instanceof ch.qos.logback.core.pattern.LiteralConverter) {
...
/* 186 */     while (p != null) {
/* 187 */       if (p instanceof ch.qos.logback.core.pattern.LiteralConverter) {
...
/* 192 */         DateTokenConverter<Object> dtc = (DateTokenConverter<Object>)p;
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\rolling\helper\FileNamePattern.class
