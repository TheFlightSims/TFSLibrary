...
/*  75 */       Interpolation interp = (Interpolation)pb.getObjectParameter(3);
...
/* 100 */       double xorig = pb.getFloatParameter(0);
/* 101 */       double yorig = pb.getFloatParameter(1);
/* 102 */       double angle = pb.getFloatParameter(2);
/* 105 */       AffineTransform transform = AffineTransform.getRotateInstance(angle, xorig, yorig);
/* 109 */       ROI dstROI = srcROI.transform(transform);
/* 112 */       Rectangle dstBounds = op.getBounds();
/* 115 */       if (!dstBounds.contains(dstROI.getBounds()))
/* 116 */         dstROI = dstROI.intersect((ROI)new ROIShape(dstBounds)); 
/* 120 */       return dstROI;
/*     */     } 
/* 123 */     return Image.UndefinedProperty;
/*     */   }
/*     */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\javax\media\jai\operator\RotatePropertyGenerator.class
