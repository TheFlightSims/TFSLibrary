...
public class SchemaDOM extends DefaultDocument {
  ...
  private void processElement(QName paramQName, XMLAttributes paramXMLAttributes, ElementImpl paramElementImpl) {
    ...
    for (byte b1 = 0; b1 < paramXMLAttributes.getLength(); b1++)
      arrayOfAttr[b1] = new AttrImpl(null, paramXMLAttributes.getPrefix(b1), paramXMLAttributes.getLocalName(b1), paramXMLAttributes.getQName(b1), paramXMLAttributes.getURI(b1), paramXMLAttributes.getValue(b1)); 
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\xs\opti\SchemaDOM.class
