...
public abstract class AbstractSAXParser extends AbstractXMLDocumentParser implements PSVIProvider, Parser, XMLReader {
  ...
  protected static final class AttributesProxy implements AttributeList, Attributes2 {
    ...
    public void setAttributes(XMLAttributes param1XMLAttributes) {
    ...
    public String getName(int param1Int) {
      return this.fAttributes.getQName(param1Int);
    }
    ...
    public String getLocalName(int param1Int) {
      return this.fAttributes.getLocalName(param1Int);
    }
    
    public String getType(int param1Int) {
      return this.fAttributes.getType(param1Int);
    }
    
    public String getType(String param1String) {
      return this.fAttributes.getType(param1String);
    }
    
    public String getType(String param1String1, String param1String2) {
      return param1String1.equals("") ? this.fAttributes.getType(null, param1String2) : this.fAttributes.getType(param1String1, param1String2);
    }
    
    public String getValue(int param1Int) {
      return this.fAttributes.getValue(param1Int);
    }
    
    public String getValue(String param1String) {
      return this.fAttributes.getValue(param1String);
    }
    
    public String getValue(String param1String1, String param1String2) {
      return param1String1.equals("") ? this.fAttributes.getValue(null, param1String2) : this.fAttributes.getValue(param1String1, param1String2);
    }
    
    public int getIndex(String param1String) {
      return this.fAttributes.getIndex(param1String);
    }
    
    public int getIndex(String param1String1, String param1String2) {
      return param1String1.equals("") ? this.fAttributes.getIndex(null, param1String2) : this.fAttributes.getIndex(param1String1, param1String2);
    }
    ...
    public boolean isDeclared(String param1String) {
    ...
    public boolean isSpecified(String param1String) {
      int i = getIndex(param1String);
      if (i == -1)
        throw new IllegalArgumentException(param1String); 
  ...
  protected static final class LocatorProxy implements Locator2 {
    ...
    public LocatorProxy(XMLLocator param1XMLLocator) {
      this.fLocator = param1XMLLocator;
    }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\parsers\AbstractSAXParser.class
