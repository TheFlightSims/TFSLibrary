...
/*  62 */     if (context != null) {
/*  64 */       Map<String, String> contextMap = (Map<String, String>)context.getObject("PATTERN_RULE_REGISTRY");
...
/*  95 */       sm.add((Status)new ErrorStatus("Failed to parse pattern \"" + getPattern() + "\".", this, (Throwable)sce));
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\pattern\PatternLayoutBase.class
