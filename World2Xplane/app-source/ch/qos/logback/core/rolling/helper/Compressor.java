...
/*  70 */       addStatus((Status)new WarnStatus("The file to compress named [" + nameOfFile2zip + "] does not exist.", this));
/*     */       return;
/*     */     } 
/*  76 */     if (innerEntryName == null) {
/*  77 */       addStatus((Status)new WarnStatus("The innerEntryName parameter cannot be null", this));
/*     */       return;
/*     */     } 
...
/*  88 */       addStatus((Status)new WarnStatus("The target compressed file named [" + nameOfZippedFile + "] exist already.", this));
/*     */       return;
/*     */     } 
...
/* 123 */       addStatus((Status)new ErrorStatus("Error occurred while compressing [" + nameOfFile2zip + "] into [" + nameOfZippedFile + "].", this, e));
/*     */     } finally {
/* 126 */       if (bis != null)
/*     */         try {
/* 128 */           bis.close();
...
/* 174 */       addStatus((Status)new WarnStatus("The file to compress named [" + nameOfFile2gz + "] does not exist.", this));
/*     */       return;
/*     */     } 
...
/* 214 */         addStatus((Status)new WarnStatus("Could not delete [" + nameOfFile2gz + "].", this)); 
/* 217 */     } catch (Exception e) {
/* 218 */       addStatus((Status)new ErrorStatus("Error occurred while compressing [" + nameOfFile2gz + "] into [" + nameOfgzedFile + "].", this, e));
/*     */     } finally {
/* 221 */       if (bis != null)
/*     */         try {
/* 223 */           bis.close();
...
/* 260 */     if (FileUtil.isParentDirectoryCreationRequired(file)) {
/* 261 */       boolean result = FileUtil.createMissingParentDirectories(file);
/* 262 */       if (!result) {
/* 263 */         addError("Failed to create parent directories for [" + file.getAbsolutePath() + "]");
/*     */       } else {
/* 266 */         addInfo("Created missing parent directories for [" + file.getAbsolutePath() + "]");
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\rolling\helper\Compressor.class
