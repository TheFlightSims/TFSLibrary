...
/* 187 */     return new AbstractSet<Map.Entry<Float, Character>>() {
/*     */         public int size() {
/* 189 */           return TFloatCharMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 193 */           return TFloatCharMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 200 */             return (TFloatCharMapDecorator.this.containsKey(k) && TFloatCharMapDecorator.this.get(k).equals(v));
/*     */           } 
/* 203 */           return false;
/*     */         }
/*     */         
/*     */         public Iterator<Map.Entry<Float, Character>> iterator() {
/* 208 */           return new Iterator<Map.Entry<Float, Character>>() {
/* 209 */               private final TFloatCharIterator it = TFloatCharMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Float, Character> next() {
/* 212 */                 this.it.advance();
/* 213 */                 float ik = this.it.key();
/* 214 */                 final Float key = (ik == TFloatCharMapDecorator.this._map.getNoEntryKey()) ? null : TFloatCharMapDecorator.this.wrapKey(ik);
/* 215 */                 char iv = this.it.value();
/* 216 */                 final Character v = (iv == TFloatCharMapDecorator.this._map.getNoEntryValue()) ? null : TFloatCharMapDecorator.this.wrapValue(iv);
/* 217 */                 return new Map.Entry<Float, Character>() {
...
/* 239 */                       this.val = value;
/* 240 */                       return TFloatCharMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 264 */             TFloatCharMapDecorator.this._map.remove(TFloatCharMapDecorator.this.unwrapKey(key));
/* 265 */             modified = true;
/*     */           } 
/* 267 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 275 */           TFloatCharMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/* 332 */     Iterator<? extends Map.Entry<? extends Float, ? extends Character>> it = map.entrySet().iterator();
/* 334 */     for (int i = map.size(); i-- > 0; ) {
/* 335 */       Map.Entry<? extends Float, ? extends Character> e = it.next();
...
/* 390 */     in.readByte();
/* 393 */     this._map = (TFloatCharMap)in.readObject();
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\decorator\TFloatCharMapDecorator.class
