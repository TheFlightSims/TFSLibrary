...
/*     */     
/*     */     Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
/* 518 */       Cut<C> cut, startingPoint = this.complementLowerBoundWindow.hasUpperBound() ? this.complementLowerBoundWindow.upperEndpoint() : (Cut)Cut.<Comparable>aboveAll();
...
/* 528 */         cut = (((Range)positiveItr.peek()).upperBound == Cut.aboveAll()) ? ((Range)positiveItr.next()).lowerBound : this.positiveRangesByLowerBound.higherKey(((Range)positiveItr.peek()).upperBound);
/*     */       } else {
/* 531 */         if (!this.complementLowerBoundWindow.contains((Cut)Cut.belowAll()) || this.positiveRangesByLowerBound.containsKey(Cut.belowAll()))
/* 533 */           return Iterators.emptyIterator(); 
/* 535 */         cut = this.positiveRangesByLowerBound.higherKey((Cut)Cut.belowAll());
/*     */       } 
/* 537 */       final Cut<C> firstComplementRangeUpperBound = (Cut<C>)Objects.firstNonNull(cut, Cut.aboveAll());
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\google\common\collect\TreeRangeSet.class
