...
/* 71 */           Image.Min(dstMLI[i], srcMLI1[i], srcMLI2[i]); 
/*    */         break;
/*    */       case 4:
/*    */       case 5:
/* 77 */         for (i = 0; i < dstMLI.length; i++)
/* 78 */           Image.Min_Fp(dstMLI[i], srcMLI1[i], srcMLI2[i]); 
/*    */         break;
/*    */       default:
/* 83 */         throw new RuntimeException(JaiI18N.getString("Generic2"));
/*    */     } 
/* 86 */     if (dstMA.isDataCopy()) {
/* 87 */       dstMA.clampDataArrays();
/* 88 */       dstMA.copyDataToRaster();
/*    */     } 
/*    */   }
/*    */ }


/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\sun\media\jai\mlib\MlibMinOpImage.class
