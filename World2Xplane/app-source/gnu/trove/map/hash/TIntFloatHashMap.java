...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TIntFloatHashMap) {
/*  134 */       TIntFloatHashMap hashmap = (TIntFloatHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Integer, ? extends Float> entry : map.entrySet())
/*  234 */       put(((Integer)entry.getKey()).intValue(), ((Float)entry.getValue()).floatValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TIntFloatMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TIntFloatIterator iter = map.iterator();
...
/*  393 */     return new TIntFloatHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TIntFloatHashMap.TIntFloatKeyHashIterator((TPrimitiveHash)TIntFloatHashMap.this);
/*      */     }
/*      */     
/*      */     public int getNoEntryValue() {
/*  521 */       return TIntFloatHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TIntFloatHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TIntFloatHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(int entry) {
/*  539 */       return TIntFloatHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public int[] toArray() {
/*  545 */       return TIntFloatHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public int[] toArray(int[] dest) {
/*  551 */       return TIntFloatHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TIntFloatHashMap.this.no_entry_value != TIntFloatHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TIntFloatHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TIntFloatHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TIntFloatHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       int[] set = TIntFloatHashMap.this._set;
/*  677 */       byte[] states = TIntFloatHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TIntFloatHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TIntFloatHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TIntProcedure procedure) {
/*  742 */       return TIntFloatHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TIntFloatHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TIntFloatHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TIntFloatHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TIntFloatHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TIntFloatHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TIntFloatHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TIntFloatHashMap.this.forEachKey(new TIntProcedure() {
...
/*  807 */       return new TIntFloatHashMap.TIntFloatValueHashIterator((TPrimitiveHash)TIntFloatHashMap.this);
/*      */     }
/*      */     
/*      */     public float getNoEntryValue() {
/*  813 */       return TIntFloatHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TIntFloatHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TIntFloatHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(float entry) {
/*  831 */       return TIntFloatHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public float[] toArray() {
/*  837 */       return TIntFloatHashMap.this.values();
/*      */     }
/*      */     
/*      */     public float[] toArray(float[] dest) {
/*  843 */       return TIntFloatHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       float[] values = TIntFloatHashMap.this._values;
/*  856 */       int[] set = TIntFloatHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0 && set[i] != 2 && entry == values[i]) {
/*  860 */           TIntFloatHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TIntFloatHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TIntFloatHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TIntFloatHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       float[] values = TIntFloatHashMap.this._values;
/*  962 */       byte[] states = TIntFloatHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TIntFloatHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TIntFloatHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TFloatProcedure procedure) {
/* 1027 */       return TIntFloatHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TIntFloatHashMap.this.forEachValue(new TFloatProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TIntFloatHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TIntFloatHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TIntFloatHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TIntFloatHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public int key() {
/* 1148 */       return TIntFloatHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public float value() {
/* 1153 */       return TIntFloatHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public float setValue(float val) {
/* 1158 */       float old = value();
/* 1159 */       TIntFloatHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TIntFloatHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TIntFloatMap))
/* 1185 */       return false; 
/* 1187 */     TIntFloatMap that = (TIntFloatMap)other;
...
/* 1230 */     forEachEntry(new TIntFloatProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TIntFloatHashMap.class
