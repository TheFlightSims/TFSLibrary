...
public class ScriptWriterText extends ScriptWriterBase {
  ...
  protected void writeSessionIdAndSchema(Session paramSession) throws IOException {
  ...
  public void writeLogStatement(Session paramSession, String paramString) throws IOException {
    if (paramSession != null) {
  ...
  public void writeRow(Session paramSession, Row paramRow, Table paramTable) throws IOException {
  ...
  public void writeOtherStatement(Session paramSession, String paramString) throws IOException {
    writeLogStatement(paramSession, paramString);
    if (this.writeDelay == 0)
      sync(); 
  }
  
  public void writeInsertStatement(Session paramSession, Row paramRow, Table paramTable) throws IOException {
    this.schemaToLog = (paramTable.getName()).schema;
    writeRow(paramSession, paramRow, paramTable);
  }
  
  public void writeDeleteStatement(Session paramSession, Table paramTable, Object[] paramArrayOfObject) throws IOException {
    this.schemaToLog = (paramTable.getName()).schema;
    writeSessionIdAndSchema(paramSession);
    this.rowOut.reset();
  ...
  public void writeSequenceStatement(Session paramSession, NumberSequence paramNumberSequence) throws IOException {
  ...
  public void writeCommitStatement(Session paramSession) throws IOException {
    writeSessionIdAndSchema(paramSession);
    this.rowOut.reset();
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\scriptio\ScriptWriterText.class
