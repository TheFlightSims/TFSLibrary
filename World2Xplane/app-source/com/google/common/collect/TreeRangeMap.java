...
/* 532 */               Cut<K> cutToStart = (Cut<K>)Objects.firstNonNull(TreeRangeMap.this.entriesByLowerBound.floorKey(TreeRangeMap.SubRangeMap.this.subRange.lowerBound), TreeRangeMap.SubRangeMap.this.subRange.lowerBound);
...
/* 542 */                       TreeRangeMap.RangeMapEntry<K, V> entry = backingItr.next();
...
/* 575 */         return new Maps.Values<Range<Range<K>>, V>(this) {
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\google\common\collect\TreeRangeMap.class
