...
/* 389 */     if (posix)
/* 390 */       flags = flags + "P"; 
/* 392 */     (new String[3])[0] = DF;
/* 392 */     (new String[3])[1] = flags;
/* 392 */     (new String[3])[2] = path;
/* 392 */     (new String[2])[0] = DF;
/* 392 */     (new String[2])[1] = path;
/* 392 */     String[] cmdAttribs = (flags.length() > 1) ? new String[3] : new String[2];
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\commons\io\FileSystemUtils.class
