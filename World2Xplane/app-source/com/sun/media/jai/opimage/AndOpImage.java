...
/* 100 */     RasterAccessor s1 = new RasterAccessor(sources[0], destRect, formatTags[0], getSourceImage(0).getColorModel());
/* 103 */     RasterAccessor s2 = new RasterAccessor(sources[1], destRect, formatTags[1], getSourceImage(1).getColorModel());
/* 106 */     RasterAccessor d = new RasterAccessor(dest, destRect, formatTags[2], getColorModel());
/* 109 */     if (d.isBinary()) {
/* 110 */       byte[] src1Bits = s1.getBinaryDataArray();
/* 111 */       byte[] src2Bits = s2.getBinaryDataArray();
/* 112 */       byte[] dstBits = d.getBinaryDataArray();
/* 114 */       int length = dstBits.length;
/* 115 */       for (int i = 0; i < length; i++)
/* 116 */         dstBits[i] = (byte)(src1Bits[i] & src2Bits[i]); 
/* 119 */       d.copyBinaryDataToRaster();
/*     */       return;
/*     */     } 
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\sun\media\jai\opimage\AndOpImage.class
