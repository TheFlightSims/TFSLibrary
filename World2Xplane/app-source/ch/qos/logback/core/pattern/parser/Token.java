...
/*     */   
/*  35 */   static Token EOF_TOKEN = new Token(2147483647, "EOF");
/*     */   
...
/* 107 */     if (this == o)
/* 107 */       return true; 
/* 108 */     if (!(o instanceof Token))
/* 108 */       return false; 
/* 110 */     Token token = (Token)o;
/* 112 */     if (this.type != token.type)
/* 112 */       return false; 
/* 113 */     if ((this.value != null) ? !this.value.equals(token.value) : (token.value != null))
/* 113 */       return false; 
/* 115 */     return true;
/*     */   }
/*     */ }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\core\pattern\parser\Token.class
