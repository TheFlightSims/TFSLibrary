...
/*     */ 
/*     */ final class MlibSubtractOpImage extends PointOpImage {
...
/*  82 */           Image.Sub(dstML[i], srcML1[i], srcML2[i]); 
/*     */         break;
/*     */       case 4:
/*     */       case 5:
/*  88 */         for (i = 0; i < dstML.length; i++)
/*  89 */           Image.Sub_Fp(dstML[i], srcML1[i], srcML2[i]); 
/*     */         break;
/*     */       default:
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\sun\media\jai\mlib\MlibSubtractOpImage.class
