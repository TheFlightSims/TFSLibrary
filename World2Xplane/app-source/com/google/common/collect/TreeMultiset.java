...
/* 901 */       if (cmp < 0)
/* 902 */         return (this.left == null) ? this : (AvlNode<E>)Objects.firstNonNull(this.left.ceiling(comparator, e), this); 
/* 903 */       if (cmp == 0)
/* 904 */         return this; 
...
/* 912 */       if (cmp > 0)
/* 913 */         return (this.right == null) ? this : (AvlNode<E>)Objects.firstNonNull(this.right.floor(comparator, e), this); 
/* 914 */       if (cmp == 0)
/* 915 */         return this; 
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\com\google\common\collect\TreeMultiset.class
