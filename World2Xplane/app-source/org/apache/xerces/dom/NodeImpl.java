  ...
  public boolean isDefaultNamespace(String paramString) {
    ...
    switch (s) {
      case 1:
        ...
        return (nodeImpl2 != null) ? nodeImpl2.isDefaultNamespace(paramString) : false;
      case 9:
      ...
      case 12:
        return false;
      case 2:
        return (this.ownerNode.getNodeType() == 1) ? this.ownerNode.isDefaultNamespace(paramString) : false;
    } 
    NodeImpl nodeImpl1 = (NodeImpl)getElementAncestor(this);
    return (nodeImpl1 != null) ? nodeImpl1.isDefaultNamespace(paramString) : false;
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\dom\NodeImpl.class
