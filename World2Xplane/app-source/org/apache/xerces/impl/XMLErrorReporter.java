...
public class XMLErrorReporter implements XMLComponent {
  ...
  public void reportError(String paramString1, String paramString2, Object[] paramArrayOfObject, short paramShort) throws XNIException {
    reportError(this.fLocator, paramString1, paramString2, paramArrayOfObject, paramShort);
  }
  
  public void reportError(String paramString1, String paramString2, Object[] paramArrayOfObject, short paramShort, Exception paramException) throws XNIException {
    reportError(this.fLocator, paramString1, paramString2, paramArrayOfObject, paramShort, paramException);
  }
  
  public void reportError(XMLLocator paramXMLLocator, String paramString1, String paramString2, Object[] paramArrayOfObject, short paramShort) throws XNIException {
    reportError(paramXMLLocator, paramString1, paramString2, paramArrayOfObject, paramShort, null);
  }
  
  public void reportError(XMLLocator paramXMLLocator, String paramString1, String paramString2, Object[] paramArrayOfObject, short paramShort, Exception paramException) throws XNIException {
    String str;
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\apache\xerces\impl\XMLErrorReporter.class
