...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TLongIntHashMap) {
/*  134 */       TLongIntHashMap hashmap = (TLongIntHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Long, ? extends Integer> entry : map.entrySet())
/*  234 */       put(((Long)entry.getKey()).longValue(), ((Integer)entry.getValue()).intValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TLongIntMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TLongIntIterator iter = map.iterator();
...
/*  393 */     return new TLongIntHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TLongIntHashMap.TLongIntKeyHashIterator((TPrimitiveHash)TLongIntHashMap.this);
/*      */     }
/*      */     
/*      */     public long getNoEntryValue() {
/*  521 */       return TLongIntHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TLongIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TLongIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(long entry) {
/*  539 */       return TLongIntHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public long[] toArray() {
/*  545 */       return TLongIntHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public long[] toArray(long[] dest) {
/*  551 */       return TLongIntHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TLongIntHashMap.this.no_entry_value != TLongIntHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TLongIntHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TLongIntHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TLongIntHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       long[] set = TLongIntHashMap.this._set;
/*  677 */       byte[] states = TLongIntHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TLongIntHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TLongIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TLongProcedure procedure) {
/*  742 */       return TLongIntHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TLongIntHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TLongIntHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TLongIntHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TLongIntHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TLongIntHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TLongIntHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TLongIntHashMap.this.forEachKey(new TLongProcedure() {
...
/*  807 */       return new TLongIntHashMap.TLongIntValueHashIterator((TPrimitiveHash)TLongIntHashMap.this);
/*      */     }
/*      */     
/*      */     public int getNoEntryValue() {
/*  813 */       return TLongIntHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TLongIntHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TLongIntHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(int entry) {
/*  831 */       return TLongIntHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public int[] toArray() {
/*  837 */       return TLongIntHashMap.this.values();
/*      */     }
/*      */     
/*      */     public int[] toArray(int[] dest) {
/*  843 */       return TLongIntHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       int[] values = TLongIntHashMap.this._values;
/*  856 */       long[] set = TLongIntHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0L && set[i] != 2L && entry == values[i]) {
/*  860 */           TLongIntHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TLongIntHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TLongIntHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TLongIntHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       int[] values = TLongIntHashMap.this._values;
/*  962 */       byte[] states = TLongIntHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TLongIntHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TLongIntHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TIntProcedure procedure) {
/* 1027 */       return TLongIntHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TLongIntHashMap.this.forEachValue(new TIntProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TLongIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TLongIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TLongIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TLongIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public long key() {
/* 1148 */       return TLongIntHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public int value() {
/* 1153 */       return TLongIntHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public int setValue(int val) {
/* 1158 */       int old = value();
/* 1159 */       TLongIntHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TLongIntHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TLongIntMap))
/* 1185 */       return false; 
/* 1187 */     TLongIntMap that = (TLongIntMap)other;
...
/* 1230 */     forEachEntry(new TLongIntProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TLongIntHashMap.class
