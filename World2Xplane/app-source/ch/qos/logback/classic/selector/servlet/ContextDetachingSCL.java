...
/*    */         return;
/*    */       } 
/* 49 */       LoggerContext context = selector.detachLoggerContext(loggerContextName);
/* 50 */       if (context != null) {
/* 51 */         Logger logger = context.getLogger("ROOT");
/* 52 */         logger.warn("Stopping logger context " + loggerContextName);
/* 54 */         context.stop();
/*    */       } else {
/* 56 */         System.out.println("No context named " + loggerContextName + " was found.");
/*    */       } 
/*    */     } 
/*    */   }
/*    */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\ch\qos\logback\classic\selector\servlet\ContextDetachingSCL.class
