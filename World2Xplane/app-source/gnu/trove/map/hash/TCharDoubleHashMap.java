...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TCharDoubleHashMap) {
/*  134 */       TCharDoubleHashMap hashmap = (TCharDoubleHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Character, ? extends Double> entry : map.entrySet())
/*  234 */       put(((Character)entry.getKey()).charValue(), ((Double)entry.getValue()).doubleValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TCharDoubleMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TCharDoubleIterator iter = map.iterator();
...
/*  393 */     return new TCharDoubleHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TCharDoubleHashMap.TCharDoubleKeyHashIterator((TPrimitiveHash)TCharDoubleHashMap.this);
/*      */     }
/*      */     
/*      */     public char getNoEntryValue() {
/*  521 */       return TCharDoubleHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TCharDoubleHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TCharDoubleHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(char entry) {
/*  539 */       return TCharDoubleHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public char[] toArray() {
/*  545 */       return TCharDoubleHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public char[] toArray(char[] dest) {
/*  551 */       return TCharDoubleHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TCharDoubleHashMap.this.no_entry_value != TCharDoubleHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TCharDoubleHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TCharDoubleHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TCharDoubleHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       char[] set = TCharDoubleHashMap.this._set;
/*  677 */       byte[] states = TCharDoubleHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TCharDoubleHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TCharDoubleHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TCharProcedure procedure) {
/*  742 */       return TCharDoubleHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TCharDoubleHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TCharDoubleHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TCharDoubleHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TCharDoubleHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TCharDoubleHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TCharDoubleHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TCharDoubleHashMap.this.forEachKey(new TCharProcedure() {
...
/*  807 */       return new TCharDoubleHashMap.TCharDoubleValueHashIterator((TPrimitiveHash)TCharDoubleHashMap.this);
/*      */     }
/*      */     
/*      */     public double getNoEntryValue() {
/*  813 */       return TCharDoubleHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TCharDoubleHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TCharDoubleHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(double entry) {
/*  831 */       return TCharDoubleHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public double[] toArray() {
/*  837 */       return TCharDoubleHashMap.this.values();
/*      */     }
/*      */     
/*      */     public double[] toArray(double[] dest) {
/*  843 */       return TCharDoubleHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       double[] values = TCharDoubleHashMap.this._values;
/*  856 */       char[] set = TCharDoubleHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != '\000' && set[i] != '\002' && entry == values[i]) {
/*  860 */           TCharDoubleHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TCharDoubleHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TCharDoubleHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TCharDoubleHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       double[] values = TCharDoubleHashMap.this._values;
/*  962 */       byte[] states = TCharDoubleHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TCharDoubleHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TCharDoubleHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TDoubleProcedure procedure) {
/* 1027 */       return TCharDoubleHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TCharDoubleHashMap.this.forEachValue(new TDoubleProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TCharDoubleHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TCharDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TCharDoubleHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TCharDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public char key() {
/* 1148 */       return TCharDoubleHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public double value() {
/* 1153 */       return TCharDoubleHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public double setValue(double val) {
/* 1158 */       double old = value();
/* 1159 */       TCharDoubleHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TCharDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TCharDoubleMap))
/* 1185 */       return false; 
/* 1187 */     TCharDoubleMap that = (TCharDoubleMap)other;
...
/* 1230 */     forEachEntry(new TCharDoubleProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TCharDoubleHashMap.class
