...
public class Types {
  ...
  public static final int[][] ALL_TYPES = new int[][] { 
      { 50, 1 }, { 25, 1 }, { 60, 1 }, { 61, 1 }, { 30, 1 }, { 16, 1 }, { 1, 1 }, { 40, 1 }, { 70, 1 }, { 91, 1 }, 
      { 3, 1 }, { 2001, 1 }, { 8, 1 }, { 6, 1 }, { 4, 1 }, { 2000, 1 }, { -8, 1 }, { 2007, 1 }, { 0, 1 }, { 2, 1 }, 
      { -9, 1 }, { 1111, 1 }, { 7, 1 }, { 20, 1 }, { 2008, 1 }, { 5, 1 }, { 2002, 1 }, { 92, 1 }, { 93, 1 }, { -6, 1 }, 
      { 12, 1 }, { 137, 1 } };
  
  static final IntValueHashMap javaTypeNumbers = new IntValueHashMap(32);
  
  private static final HashSet illegalParameterClasses = new HashSet();
  ...
  public static Type getParameterSQLType(Class paramClass) {
    ...
    if (paramClass.isArray()) {
      ...
      return (i != Integer.MIN_VALUE) ? Type.getDefaultTypeWithSize(i) : ((i == 0) ? null : Type.getDefaultTypeWithSize(i));
    } 
    return str.equals("java.sql.Array") ? Type.getDefaultArrayType(0) : null;
  }
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\org\hsqldb\types\Types.class
