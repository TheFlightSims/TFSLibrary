...
/*  132 */     super(map.size());
/*  133 */     if (map instanceof TByteShortHashMap) {
/*  134 */       TByteShortHashMap hashmap = (TByteShortHashMap)map;
...
/*  233 */     for (Map.Entry<? extends Byte, ? extends Short> entry : map.entrySet())
/*  234 */       put(((Byte)entry.getKey()).byteValue(), ((Short)entry.getValue()).shortValue()); 
/*      */   }
/*      */   
/*      */   public void putAll(TByteShortMap map) {
/*  241 */     ensureCapacity(map.size());
/*  242 */     TByteShortIterator iter = map.iterator();
...
/*  393 */     return new TByteShortHashIterator(this);
/*      */   }
/*      */   
...
/*  515 */       return new TByteShortHashMap.TByteShortKeyHashIterator((TPrimitiveHash)TByteShortHashMap.this);
/*      */     }
/*      */     
/*      */     public byte getNoEntryValue() {
/*  521 */       return TByteShortHashMap.this.no_entry_key;
/*      */     }
/*      */     
/*      */     public int size() {
/*  527 */       return TByteShortHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  533 */       return (0 == TByteShortHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(byte entry) {
/*  539 */       return TByteShortHashMap.this.contains(entry);
/*      */     }
/*      */     
/*      */     public byte[] toArray() {
/*  545 */       return TByteShortHashMap.this.keys();
/*      */     }
/*      */     
/*      */     public byte[] toArray(byte[] dest) {
/*  551 */       return TByteShortHashMap.this.keys(dest);
/*      */     }
/*      */     
...
/*  567 */       return (TByteShortHashMap.this.no_entry_value != TByteShortHashMap.this.remove(entry));
/*      */     }
/*      */     
...
/*  576 */           if (!TByteShortHashMap.this.containsKey(ele))
/*  577 */             return false; 
/*      */           continue;
/*      */         } 
/*  580 */         return false;
...
/*  591 */         if (!TByteShortHashMap.this.containsKey(iter.next()))
/*  592 */           return false; 
/*      */       } 
/*  595 */       return true;
/*      */     }
...
/*  602 */         if (!TByteShortHashMap.this.contains(element))
/*  603 */           return false; 
/*      */       } 
/*  606 */       return true;
/*      */     }
...
/*  676 */       byte[] set = TByteShortHashMap.this._set;
/*  677 */       byte[] states = TByteShortHashMap.this._states;
/*  679 */       for (int i = set.length; i-- > 0;) {
/*  680 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  681 */           TByteShortHashMap.this.removeAt(i);
/*  682 */           changed = true;
/*      */         } 
/*      */       } 
/*  685 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  736 */       TByteShortHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TByteProcedure procedure) {
/*  742 */       return TByteShortHashMap.this.forEachKey(procedure);
/*      */     }
/*      */     
...
/*  753 */         return false; 
/*  755 */       for (int i = TByteShortHashMap.this._states.length; i-- > 0;) {
/*  756 */         if (TByteShortHashMap.this._states[i] == 1 && 
/*  757 */           !that.contains(TByteShortHashMap.this._set[i]))
/*  758 */           return false; 
/*      */       } 
/*  762 */       return true;
/*      */     }
...
/*      */     public int hashCode() {
/*  768 */       int hashcode = 0;
/*  769 */       for (int i = TByteShortHashMap.this._states.length; i-- > 0;) {
/*  770 */         if (TByteShortHashMap.this._states[i] == 1)
/*  771 */           hashcode += HashFunctions.hash(TByteShortHashMap.this._set[i]); 
/*      */       } 
/*  774 */       return hashcode;
/*      */     }
/*      */     
...
/*  781 */       TByteShortHashMap.this.forEachKey(new TByteProcedure() {
...
/*  807 */       return new TByteShortHashMap.TByteShortValueHashIterator((TPrimitiveHash)TByteShortHashMap.this);
/*      */     }
/*      */     
/*      */     public short getNoEntryValue() {
/*  813 */       return TByteShortHashMap.this.no_entry_value;
/*      */     }
/*      */     
/*      */     public int size() {
/*  819 */       return TByteShortHashMap.this._size;
/*      */     }
/*      */     
/*      */     public boolean isEmpty() {
/*  825 */       return (0 == TByteShortHashMap.this._size);
/*      */     }
/*      */     
/*      */     public boolean contains(short entry) {
/*  831 */       return TByteShortHashMap.this.containsValue(entry);
/*      */     }
/*      */     
/*      */     public short[] toArray() {
/*  837 */       return TByteShortHashMap.this.values();
/*      */     }
/*      */     
/*      */     public short[] toArray(short[] dest) {
/*  843 */       return TByteShortHashMap.this.values(dest);
/*      */     }
/*      */     
...
/*  855 */       short[] values = TByteShortHashMap.this._values;
/*  856 */       byte[] set = TByteShortHashMap.this._set;
/*  858 */       for (int i = values.length; i-- > 0;) {
/*  859 */         if (set[i] != 0 && set[i] != 2 && entry == values[i]) {
/*  860 */           TByteShortHashMap.this.removeAt(i);
/*  861 */           return true;
/*      */         } 
/*      */       } 
/*  864 */       return false;
...
/*  873 */           if (!TByteShortHashMap.this.containsValue(ele))
/*  874 */             return false; 
/*      */           continue;
/*      */         } 
/*  877 */         return false;
...
/*  888 */         if (!TByteShortHashMap.this.containsValue(iter.next()))
/*  889 */           return false; 
/*      */       } 
/*  892 */       return true;
/*      */     }
...
/*  899 */         if (!TByteShortHashMap.this.containsValue(element))
/*  900 */           return false; 
/*      */       } 
/*  903 */       return true;
/*      */     }
...
/*  961 */       short[] values = TByteShortHashMap.this._values;
/*  962 */       byte[] states = TByteShortHashMap.this._states;
/*  964 */       for (int i = values.length; i-- > 0;) {
/*  965 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  966 */           TByteShortHashMap.this.removeAt(i);
/*  967 */           changed = true;
/*      */         } 
/*      */       } 
/*  970 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1021 */       TByteShortHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public boolean forEach(TShortProcedure procedure) {
/* 1027 */       return TByteShortHashMap.this.forEachValue(procedure);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1034 */       final StringBuilder buf = new StringBuilder("{");
/* 1035 */       TByteShortHashMap.this.forEachValue(new TShortProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1069 */       return TByteShortHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1081 */         TByteShortHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/* 1107 */       return TByteShortHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1119 */         TByteShortHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */     
/*      */     public byte key() {
/* 1148 */       return TByteShortHashMap.this._set[this._index];
/*      */     }
/*      */     
/*      */     public short value() {
/* 1153 */       return TByteShortHashMap.this._values[this._index];
/*      */     }
/*      */     
/*      */     public short setValue(short val) {
/* 1158 */       short old = value();
/* 1159 */       TByteShortHashMap.this._values[this._index] = val;
/* 1160 */       return old;
/*      */     }
/*      */     
/*      */     public void remove() {
...
/* 1171 */         TByteShortHashMap.this.removeAt(this._index);
/*      */       } finally {
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1184 */     if (!(other instanceof TByteShortMap))
/* 1185 */       return false; 
/* 1187 */     TByteShortMap that = (TByteShortMap)other;
...
/* 1230 */     forEachEntry(new TByteShortProcedure() {
/*      */           private boolean first = true;
/*      */           
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\map\hash\TByteShortHashMap.class
