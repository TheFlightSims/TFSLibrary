...
/* 187 */     return new AbstractSet<Map.Entry<Byte, Byte>>() {
/*     */         public int size() {
/* 189 */           return TByteByteMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 193 */           return TByteByteMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 200 */             return (TByteByteMapDecorator.this.containsKey(k) && TByteByteMapDecorator.this.get(k).equals(v));
/*     */           } 
/* 203 */           return false;
/*     */         }
/*     */         
/*     */         public Iterator<Map.Entry<Byte, Byte>> iterator() {
/* 208 */           return new Iterator<Map.Entry<Byte, Byte>>() {
/* 209 */               private final TByteByteIterator it = TByteByteMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Byte, Byte> next() {
/* 212 */                 this.it.advance();
/* 213 */                 byte ik = this.it.key();
/* 214 */                 final Byte key = (ik == TByteByteMapDecorator.this._map.getNoEntryKey()) ? null : TByteByteMapDecorator.this.wrapKey(ik);
/* 215 */                 byte iv = this.it.value();
/* 216 */                 final Byte v = (iv == TByteByteMapDecorator.this._map.getNoEntryValue()) ? null : TByteByteMapDecorator.this.wrapValue(iv);
/* 217 */                 return new Map.Entry<Byte, Byte>() {
...
/* 239 */                       this.val = value;
/* 240 */                       return TByteByteMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 264 */             TByteByteMapDecorator.this._map.remove(TByteByteMapDecorator.this.unwrapKey(key));
/* 265 */             modified = true;
/*     */           } 
/* 267 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 275 */           TByteByteMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/* 332 */     Iterator<? extends Map.Entry<? extends Byte, ? extends Byte>> it = map.entrySet().iterator();
/* 334 */     for (int i = map.size(); i-- > 0; ) {
/* 335 */       Map.Entry<? extends Byte, ? extends Byte> e = it.next();
...
/* 390 */     in.readByte();
/* 393 */     this._map = (TByteByteMap)in.readObject();
/*     */   }
/*     */   
...
/* Location:              D:\#source-code\TheFlightSims\TFSLibrary\World2Xplane\World2XPlane.jar!\gnu\trove\decorator\TByteByteMapDecorator.class
